        ...
        for i in range(0,len(self.testLOBSITE_list)):
            ...
            if Flag==True:
                ...
                for n in range(0,len(site_list)):
                    ...
                    AgentInfo=GetAgent.get_TLandAgentInfofromAdmin_Byrole(self.adminurl, lobname, sitename, self.OMuserid, self.OMpassword, self.role)
                    ...
                    for ywm in range(0,len(self.tablist)):
                        ...
                        print "is in testing:"
                        time.sleep(Gl.waittime)
                        GoalValue_OnPerformancePage=AP.get_GoalValue_page()
                        print 'goal on performance:', GoalValue_OnPerformancePage
                        TeamValue_OnperformancePage=AP.get_TeamValue_page()
                        print "TeamValue_OnperformancePage:", TeamValue_OnperformancePage
                        AgentValue_OnPerformancePage=AP.get_AgentValue_page()
                        print 'AgentValue_OnPerformancePage:',AgentValue_OnPerformancePage
                    '''
