...
from Performance_Cases_MOVERS.Get_PerformanceData_Expected_MOVERS import Get_PerformanceData_Expected_MOVERS
from Performance_Cases_MOVERS.Check_All_MOVERS import Check_All_MOVERS
...
class MOVERS_Performance_OM(unittest.TestCase):


    def setUp(self):
        self.caseID="MOVERS_Performance_OM"
    ...
    def test_MOVERS_Performance_OM(self):
        ...
        #Get Goal Expected
        GetPData_Expected=Get_PerformanceData_Expected_MOVERS()
        Check_all=Check_All_MOVERS()
        ...
        for i in range(0,len(self.testLOBSITE_list)):
            ...
            if Flag==True:
                ...
                for n in range(0,len(site_list)):
                    ...
                    Achiev_SITE_Monthly=GetPData_Actual.get_MOVERS_SITE_Data_()['Achiev'][0]
                    ...
                    if lobname in Gl.performancefor_MultiTimeTab_lob:
                        for i in range(0,len(Timetablist)):
                            ...
                            Expected_GoalDic=GetPData_Expected.get_MOVERS_Goal_Expected(lineindex)
                            print Expected_GoalDic
                            Actual_GoalDic=GetPData_Actual.get_MOVERS_Goal_Actual()#GET ACTUAL GOAL FORM PERFORMANCE PAGE
                            ...
                            Actual_KPIofSITEDic=GetPData_Actual.get_MOVERS_SITE_Data_()
                            #Step2:Verify SITE
