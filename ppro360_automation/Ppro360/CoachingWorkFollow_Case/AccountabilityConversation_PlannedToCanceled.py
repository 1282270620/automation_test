...
class AccountabilityConversation_PlannedToCanceled(unittest.TestCase):


    def setUp(self):
        #Case ID
        self.caseID="AccountabilityConversation_PlannedToCanceled"
        ...
        for i in range(0,len(self.testLOBSITE_list)):
            ...
            if Flag==True:
                ...
                for n in range(0,len(site_list)):
                    ...
                    '''Check1:Enter form detail page with title Coaching - Accountability Conversation'''
                    assert Header.get_HeaderTittle()==self.coachpagetitle
                    
                    #Step5:Click button "Cancel Coaching"
                    BasicInfo.Click_Button(4)
                    '''Check2: 1.Pop up window with  title 'Accountability Conversation'.
                    ...
                    assert AccountabilityConversationForm.get_evaluate()==""
                    assert AccountabilityConversationForm.get_checkfu()==""
                    assert AccountabilityConversationForm.get_iarar()==""
                    assert AccountabilityConversationForm.get_seac()==""
                    assert AccountabilityConversationForm.get_otherNotesAndRemarks()==""
                    assert AccountabilityConversationForm.get_reconfirmUnderstanding()==""
                    ...
                    '''Check8:1.Enter form detail page with title 'Coaching - Accountability Conversation'
