...
class BehaviorCoachingForm_PlannedToCanceled(unittest.TestCase):


    def setUp(self):
        #Case ID
        self.caseID="BehaviorCoachingForm_PlannedToCanceled"
    ...
    def test_BehaviorCoachingForm_PlannedToCanceled(self):
        ...
        for i in range(0,len(self.testLOBSITE_list)):
            ...
            if Flag==True:
                ...
                for n in range(0,len(site_list)):
                    ...
                    assert BehaviorCoachingFormForm.get_firstfourcomments(1)==""
                    assert BehaviorCoachingFormForm.get_firstfourcomments(2)==""
                    assert BehaviorCoachingFormForm.get_firstfourcomments(3)==""
                    assert BehaviorCoachingFormForm.get_firstfourcomments(4)==""
                    assert BehaviorCoachingFormForm.get_lastfourcomments(3)==""
                    assert BehaviorCoachingFormForm.get_lastfourcomments(4)==""
                    assert BehaviorCoachingFormForm.get_lastfourcomments(5)==""
                    assert BehaviorCoachingFormForm.get_lastfourcomments(6)==""
