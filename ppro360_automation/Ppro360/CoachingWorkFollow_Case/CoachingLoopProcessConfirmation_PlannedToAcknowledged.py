...
from CoachingAndTriadCoaching_Pages.CoachingLoopProcessConfirmationPage import CoachingLoopProcessConfirmationPage
...
class CoachingLoopProcessConfirmation_PlannedToAcknowledged(unittest.TestCase):


    def setUp(self):
        #Case ID
        self.caseID="CoachingLoopProcessConfirmation_PlanedToAcknowledged"
        ...
        #Coachformname
        self.coachformname="Coaching Loop Process Confirmation" 
    ...
    def test_CoachingLoopProcessConfirmation_PlanedToAcknowledged(self):
        ...
        Header=HeaderPage()
        CoachingLoopProcessConfirmationForm=CoachingLoopProcessConfirmationPage()
        ...
        for i in range(0,len(self.testLOBSITE_list)):
            ...
            if Flag==True:
                ...
                for n in range(0,len(site_list)):
                    ...
                    '''Check2:1.Page title :'Coaching - CoachingLoopProcessConfirmation'.
                    ...
                    #CoachHome.click_eachcoach(typename_path)
                    CoachHome.click_eachcoach(1)
                    '''Check7:Enter the  form detail page with title 'Coaching - Coaching Loop Process Confirmation'''
                    assert Header.get_HeaderTittle()==self.coachpagetitle 
                    ...
                    CoachingLoopProcessConfirmationForm.input_ActionOneComments(self.Longtextboxesprefix1+CoachingLoopProcessConfirmationForm.get_TextboxTitle(3))
                    CoachingLoopProcessConfirmationForm.input_ActionTwoComments(self.Longtextboxesprefix1+CoachingLoopProcessConfirmationForm.get_TextboxTitle(5))
                    CoachingLoopProcessConfirmationForm.input_ActionThreeComments(self.Longtextboxesprefix1+CoachingLoopProcessConfirmationForm.get_TextboxTitle(7))
                    CoachingLoopProcessConfirmationForm.input_ActionFourComments(self.Longtextboxesprefix1+CoachingLoopProcessConfirmationForm.get_TextboxTitle(9))
                    CoachingLoopProcessConfirmationForm.input_ActionFiveComments(self.Longtextboxesprefix1+CoachingLoopProcessConfirmationForm.get_TextboxTitle(11))
                    CoachingLoopProcessConfirmationForm.input_Recommendations(self.Longtextboxesprefix1+CoachingLoopProcessConfirmationForm.get_TextboxTitle(12))
                    ...
                    for index in range(6,KPInumber+1):
                        assert BasicInfo.get_anyCheckBoxStatus(index)==self.CheckBox_UnCheckedStatus
                    assert CoachingLoopProcessConfirmationForm.get_ActionOneComments()==self.Longtextboxesprefix1+CoachingLoopProcessConfirmationForm.get_TextboxTitle(3)
                    assert CoachingLoopProcessConfirmationForm.get_ActionTwoComments()==self.Longtextboxesprefix1+CoachingLoopProcessConfirmationForm.get_TextboxTitle(5)
                    assert CoachingLoopProcessConfirmationForm.get_ActionThreeComments()==self.Longtextboxesprefix1+CoachingLoopProcessConfirmationForm.get_TextboxTitle(7)
                    assert CoachingLoopProcessConfirmationForm.get_ActionFourComments()==self.Longtextboxesprefix1+CoachingLoopProcessConfirmationForm.get_TextboxTitle(9)
                    assert CoachingLoopProcessConfirmationForm.get_ActionFiveComments()==self.Longtextboxesprefix1+CoachingLoopProcessConfirmationForm.get_TextboxTitle(11)
                    assert CoachingLoopProcessConfirmationForm.get_Recommendations()==self.Longtextboxesprefix1+CoachingLoopProcessConfirmationForm.get_TextboxTitle(12)
                    ...
                    CoachingLoopProcessConfirmationForm.input_ActionOneComments(self.Longtextboxesprefix2+CoachingLoopProcessConfirmationForm.get_TextboxTitle(3))
                    CoachingLoopProcessConfirmationForm.input_ActionTwoComments(self.Longtextboxesprefix2+CoachingLoopProcessConfirmationForm.get_TextboxTitle(5))
                    CoachingLoopProcessConfirmationForm.input_ActionThreeComments(self.Longtextboxesprefix2+CoachingLoopProcessConfirmationForm.get_TextboxTitle(7))
                    CoachingLoopProcessConfirmationForm.input_ActionFourComments(self.Longtextboxesprefix2+CoachingLoopProcessConfirmationForm.get_TextboxTitle(9))
                    CoachingLoopProcessConfirmationForm.input_ActionFiveComments(self.Longtextboxesprefix2+CoachingLoopProcessConfirmationForm.get_TextboxTitle(11))
                    CoachingLoopProcessConfirmationForm.input_Recommendations(self.Longtextboxesprefix2+CoachingLoopProcessConfirmationForm.get_TextboxTitle(12))
                    ...
                    assert CoachingLoopProcessConfirmationForm.get_ActionOneComments()==self.Longtextboxesprefix2+CoachingLoopProcessConfirmationForm.get_TextboxTitle(3)
                    assert CoachingLoopProcessConfirmationForm.get_ActionTwoComments()==self.Longtextboxesprefix2+CoachingLoopProcessConfirmationForm.get_TextboxTitle(5)
                    assert CoachingLoopProcessConfirmationForm.get_ActionThreeComments()==self.Longtextboxesprefix2+CoachingLoopProcessConfirmationForm.get_TextboxTitle(7)
                    assert CoachingLoopProcessConfirmationForm.get_ActionFourComments()==self.Longtextboxesprefix2+CoachingLoopProcessConfirmationForm.get_TextboxTitle(9)
                    assert CoachingLoopProcessConfirmationForm.get_ActionFiveComments()==self.Longtextboxesprefix2+CoachingLoopProcessConfirmationForm.get_TextboxTitle(11)
                    assert CoachingLoopProcessConfirmationForm.get_Recommendations()==self.Longtextboxesprefix2+CoachingLoopProcessConfirmationForm.get_TextboxTitle(12)   
                    ...
                    assert CoachingLoopProcessConfirmationForm.ActionOneComments_disabled()=='true'
                    assert CoachingLoopProcessConfirmationForm.ActionTwoComments_disabled()=='true'
                    assert CoachingLoopProcessConfirmationForm.ActionThreeComments_disabled()=='true'
                    assert CoachingLoopProcessConfirmationForm.ActionFourComments_disabled()=='true'
                    assert CoachingLoopProcessConfirmationForm.ActionFiveComments_disabled()=='true'
                    assert CoachingLoopProcessConfirmationForm.Recommendations_disabled()=='true'
                    ...
                    '''Check18:1.This  form record should be in the list
                               2. Enter the  form detail page with title 'Coaching - Coaching Loop Process Confirmation' On this form:1)Status = Completed; 2)Completed Date = The date when the form is completed;3)Acknowledged Date=blank
