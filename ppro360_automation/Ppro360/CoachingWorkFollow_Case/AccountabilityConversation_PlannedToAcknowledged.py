...
import MySQLdb
from CoachingAndTriadCoaching_Pages.AccountabilityConversation import AccountabilityConversation
...
class AccountabilityConversation_PlanedToAcknowledged(unittest.TestCase):


    def setUp(self):
        #Case ID
        self.caseID="AccountabilityConversation_PlanedToAcknowledged"
        ...
        #Coachformname
        self.coachformname="Accountability Conversation" 
    ...
    def test_AccountabilityConversation_PlanedToAcknowledged(self):
        ...
        Header=HeaderPage()
        AccountabilityConversationForm=AccountabilityConversation()
        ...
        for i in range(0,len(self.testLOBSITE_list)):
            ...
            if Flag==True:
                ...
                for n in range(0,len(site_list)):
                    ...
                    AccountabilityConversationForm.input_evaluate(Content_InTextBox)
                    AccountabilityConversationForm.input_checkfu(Content_InTextBox)
                    AccountabilityConversationForm.input_iarar(Content_InTextBox)
                    AccountabilityConversationForm.input_seac(Content_InTextBox)
                    AccountabilityConversationForm.input_reconfirmUnderstanding(Content_InTextBox)
                    AccountabilityConversationForm.input_otherNotesAndRemarks(Content_InTextBox)
                    ...
                    for index in range(6,KPInumber+1):
                        assert BasicInfo.get_anyCheckBoxStatus(index)==self.CheckBox_UnCheckedStatus
                    assert AccountabilityConversationForm.get_evaluate()==Content_InTextBox
                    assert AccountabilityConversationForm.get_checkfu()==Content_InTextBox
                    assert AccountabilityConversationForm.get_iarar()==Content_InTextBox
                    assert AccountabilityConversationForm.get_seac()==Content_InTextBox                    
                    assert AccountabilityConversationForm.get_reconfirmUnderstanding()==Content_InTextBox                    
                    assert AccountabilityConversationForm.get_otherNotesAndRemarks()==Content_InTextBox
                    ...
                    AccountabilityConversationForm.input_evaluate(Content_InTextBox_new)
                    AccountabilityConversationForm.input_checkfu(Content_InTextBox_new)
                    AccountabilityConversationForm.input_iarar(Content_InTextBox_new)
                    AccountabilityConversationForm.input_seac(Content_InTextBox_new)
                    AccountabilityConversationForm.input_reconfirmUnderstanding(Content_InTextBox_new)
                    AccountabilityConversationForm.input_otherNotesAndRemarks(Content_InTextBox_new)
                    ...
                    assert AccountabilityConversationForm.get_evaluate()==Content_InTextBox_new
                    assert AccountabilityConversationForm.get_checkfu()==Content_InTextBox_new
                    assert AccountabilityConversationForm.get_iarar()==Content_InTextBox_new
                    assert AccountabilityConversationForm.get_seac()==Content_InTextBox_new                    
                    assert AccountabilityConversationForm.get_reconfirmUnderstanding()==Content_InTextBox_new                    
                    assert AccountabilityConversationForm.get_otherNotesAndRemarks()==Content_InTextBox_new
                    ...
                    for index in range(6,KPInumber+1):
                        assert BasicInfo.get_anyCheckBoxStatus(index)==self.CheckBox_UnCheckedStatus
                    assert AccountabilityConversationForm.evaluate__disabled()=="true"
                    assert AccountabilityConversationForm.checkfu__disabled()=="true"
                    assert AccountabilityConversationForm.iarar__disabled()=="true" 
                    assert AccountabilityConversationForm.seac__disabled()=="true"
                    assert AccountabilityConversationForm.reconfirmUnderstanding__disabled()=="true"
                    assert AccountabilityConversationForm.otherNotesAndRemarks__disabled()=="true"
