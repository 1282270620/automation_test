...
class CoachingLoopProcessConfirmation_PlanedToCanceled(unittest.TestCase):


    def setUp(self):
        #Case ID
        self.caseID="CoachingLoopProcessConfirmation_PlannedToCanceled"
        ...
        for i in range(0,len(self.testLOBSITE_list)):
            ...
            if Flag==True:
                ...
                for n in range(0,len(site_list)):
                    ...
                    assert CoachingLoopProcessConfirmationForm.get_ActionOneComments()==""
                    assert CoachingLoopProcessConfirmationForm.get_ActionTwoComments()==""
                    assert CoachingLoopProcessConfirmationForm.get_ActionThreeComments()==""
                    assert CoachingLoopProcessConfirmationForm.get_ActionFourComments()==""
                    assert CoachingLoopProcessConfirmationForm.get_ActionFiveComments()==""
                    assert CoachingLoopProcessConfirmationForm.get_Recommendations()==""                    
