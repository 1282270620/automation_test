...
class SettingExpectations_PlannedToAcknowledged(unittest.TestCase):


    def setUp(self):
        #Case ID
        self.caseID="SettingExpectations_PlannedToAcknowledged"
    ...
    def test_SettingExpectations_PlanedToAcknowledged(self):
        ...
        for i in range(0,len(self.testLOBSITE_list)):
            ...
            if Flag==True:
                ...
                for n in range(0,len(site_list)):
                    ...
                    '''Check2:1.Page title :'Coaching - Setting Expectations'.
                    ...
                    #CoachHome.click_eachcoach(typename_path)
                    CoachHome.click_eachcoach(1)
                    '''Check7:Enter the  form detail page with title 'Coaching - Setting Expectations'''
                    assert Header.get_HeaderTittle()==self.coachpagetitle 
                    ...
                    SettingExpectationsForm.input_establishExpectation(Content_InTextBox_new)
                    SettingExpectationsForm.input_reason(Content_InTextBox_new)
                    SettingExpectationsForm.input_resources(Content_InTextBox_new)
                    SettingExpectationsForm.input_verifyUnderstanding(Content_InTextBox_new)
                    SettingExpectationsForm.input_verifyCommitment(Content_InTextBox_new)
                    SettingExpectationsForm.input_confidenceBuilder(Content_InTextBox_new)
                    SettingExpectationsForm.input_otherNotesAndRemarks(Content_InTextBox_new)
                    ...
                    assert SettingExpectationsForm.get_establishExpectation()==Content_InTextBox_new
                    assert SettingExpectationsForm.get_reason()==Content_InTextBox_new
                    assert SettingExpectationsForm.get_resources()==Content_InTextBox_new
                    assert SettingExpectationsForm.get_verifyUnderstanding()==Content_InTextBox_new
                    assert SettingExpectationsForm.get_verifyCommitment()==Content_InTextBox_new
                    assert SettingExpectationsForm.get_confidenceBuilder()==Content_InTextBox_new
                    assert SettingExpectationsForm.get_otherNotesAndRemarks()==Content_InTextBox_new
