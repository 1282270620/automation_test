...
from CoachingAndTriadCoaching_Pages.ICHYWTFormPage import ICHYWTFormPage
...
class ICHYWTForm_PlannedToCompleted(unittest.TestCase):


    def setUp(self):
        #Case ID
        self.caseID="ICHYWTForm_PlannedToCompleted"
        ...
        self.coachformname="ICHYWT Form" 
    ...
    def test_ICHYWTForm_PlannedToCompleted(self):
        ...
        for i in range(0,len(self.testLOBSITE_list)):
            ...
            if Flag==True:
                ...
                for n in range(0,len(site_list)):
                    ...
                    for i in range(3,13):
                        assert ICHYWTForm.BodyComments_disabled(i)=='true'
                    ICHYWTForm.Click_BodyButton(3, 1)
                    assert ICHYWTForm.get_BodyButtonStatus(3, 1)==self.uncheckstatus
                    ICHYWTForm.Click_BodyButton(4, 2)
                    assert ICHYWTForm.get_BodyButtonStatus(4, 2)==self.uncheckstatus
                    ...
                    for i1 in range(3,13):
                        ICHYWTForm.input_BodyComments(i1, self.Shorttextboxesprefix1)
                        if i1==3:
                            ICHYWTForm.Click_BodyButton(i1, 1)
                        else:
                            ICHYWTForm.Click_BodyButton(i1, 2)
                    ...
                    assert ICHYWTForm.get_BodyButtonStatus(3, 1)==self.checkstatus
                    assert ICHYWTForm.get_BodyButtonStatus(3, 2)==self.uncheckstatus
                    for i3 in range(3,13):
                        assert ICHYWTForm.get_BodyComments(i3)==self.Shorttextboxesprefix1
                        if i3==3:
                            assert ICHYWTForm.get_BodyButtonStatus(i3, 1)==self.checkstatus
                            assert ICHYWTForm.get_BodyButtonStatus(i3, 2)==self.uncheckstatus
                        else:
                            assert ICHYWTForm.get_BodyButtonStatus(i3, 2)==self.checkstatus
                            assert ICHYWTForm.get_BodyButtonStatus(i3, 1)==self.uncheckstatus
