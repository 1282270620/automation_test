...
class Commendation_OngoingToCanceled(unittest.TestCase):


    def setUp(self):
        #Case ID
        self.caseID="Commendation_OngoingToCanceled"
        ...
        for i in range(0,len(self.testLOBSITE_list)):
            ...
            if Flag==True:
                ...
                for n in range(0,len(site_list)):
                    ...
                    callRecordingID=self.Shorttextboxesprefix1+CommendationForm.get_callRecordingIDBoxTitle()
                    Content_InTextBox=self.Longtextboxesprefix1+CommendationForm.get_commendationBoxTitle()
                    CommendationForm.input_callRecordingID(callRecordingID)
                    CommendationForm.select_anyDateTimeOfCall(1, 1)
                    DateTimeOfCall=CommendationForm.get_DateandTimeofCall()
                    ...
                    assert CommendationForm.get_callRecordingID()==callRecordingID
                    assert CommendationForm.get_DateandTimeofCall()==DateTimeOfCall
