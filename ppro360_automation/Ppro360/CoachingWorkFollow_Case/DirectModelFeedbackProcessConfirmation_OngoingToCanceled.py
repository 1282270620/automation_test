...
class DirectModelFeedbackProcessConfirmation_OngoingToCanceled(unittest.TestCase):


    def setUp(self):
        #Case ID
        self.caseID="DirectModelFeedbackProcessConfirmation_OngoingToCanceled"
    ...
    def test_Commendation_OngoingToCanceled(self):
            ...
            if Flag==True:
                ...
                for n in range(0,len(site_list)):
                    ...
                    #Step1:1.Login with creater LC/OM/TL to enter performance Month-To-Date page.
                            ...
                            #4.Input value in all editable fields with following content:
                    ...
                    #print "DirectModelFeedbackProcessConfirmationForm.get_comments()==(self.Longtextboxesprefix1+DirectModelFeedbackProcessConfirmationForm.get_TextboxTitle(3), lineindex)"
                    #print DirectModelFeedbackProcessConfirmationForm.get_comments() 
                    #print (self.Longtextboxesprefix1+DirectModelFeedbackProcessConfirmationForm.get_TextboxTitle(3), lineindex)
