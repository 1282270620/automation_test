...
import MySQLdb
from CoachingAndTriadCoaching_Pages.DFMCoachingpage import DFMCoachingpage
...
class DFM_PlannedToAcknoeledged(unittest.TestCase):


    def setUp(self):
        #Case ID
        self.caseID="DFM_PlanedToAcknowledged"
        ...
        for i in range(0,len(self.testLOBSITE_list)):
            ...
            if Flag==True:
                ...
                for n in range(0,len(site_list)):
                    ...
                    '''Check2:1.Page title :'Coaching - DFM'.
                    ...
                    if lobname in Gl.DoubleKPIname_lob:
                            ...
                            for a2 in range(0,len(Goal_TwoValue_index_list)):
                                ...
                                #print "(KPIofGoal_FromPerformancePage_list[i].split("'\n'"))[1]==(KPIofGoal_FromDetailPage_list[i].split("'\n'"))[0]==(KPIofGoal_FromDetailPage_list[i].split("'\n'"))[1]"
                                #print (KPIofGoal_FromPerformancePage_list[i].split("\n"))[1]
                                #print (KPIofGoal_FromDetailPage_list[i].split("\n"))[0]
                                #print (KPIofGoal_FromDetailPage_list[i].split("\n"))[1]
                    ...
                    #CoachHome.click_eachcoach(typename_path)
                    CoachHome.click_eachcoach(1)
                    '''Check7:Enter the  form detail page with title 'Coaching - DFM'''
                    assert Header.get_HeaderTittle()==self.coachpagetitle 
                    ...
                    DFMForm.input_agentOpinion(self.Longtextboxesprefix1+DFMForm.get_TextboxTitle(2))
                    DFMForm.input_leaderSuggestion(self.Longtextboxesprefix1+DFMForm.get_TextboxTitle(3))
                    DFMForm.input_agentImprovement(self.Longtextboxesprefix1+DFMForm.get_TextboxTitle(4))
                    DFMForm.input_improvementSuggestion(self.Longtextboxesprefix1+DFMForm.get_TextboxTitle(5))
                    DFMForm.input_actionDetail(self.Longtextboxesprefix1+DFMForm.get_TextboxTitle(6))
                    DFMForm.input_addtionalComments(self.Longtextboxesprefix1+DFMForm.get_TextboxTitle(7))
                    ...
                    for index in range(6,KPInumber+1):
                        assert BasicInfo.get_anyCheckBoxStatus(index)==self.CheckBox_UnCheckedStatus
                    assert DFMForm.get_agentOpinion()==self.Longtextboxesprefix1+DFMForm.get_TextboxTitle(2)
                    assert DFMForm.get_leaderSuggestion()==self.Longtextboxesprefix1+DFMForm.get_TextboxTitle(3)
                    assert DFMForm.get_agentImprovement()==self.Longtextboxesprefix1+DFMForm.get_TextboxTitle(4)
                    assert DFMForm.get_improvementSuggestion()==self.Longtextboxesprefix1+DFMForm.get_TextboxTitle(5)
                    assert DFMForm.get_actionDetail()==self.Longtextboxesprefix1+DFMForm.get_TextboxTitle(6)
                    assert DFMForm.get_addtionalComments()==self.Longtextboxesprefix1+DFMForm.get_TextboxTitle(7)
                    ...
                    DFMForm.input_agentOpinion(self.Longtextboxesprefix2+DFMForm.get_TextboxTitle(2))
                    DFMForm.input_leaderSuggestion(self.Longtextboxesprefix2+DFMForm.get_TextboxTitle(3))
                    DFMForm.input_agentImprovement(self.Longtextboxesprefix2+DFMForm.get_TextboxTitle(4))
                    DFMForm.input_improvementSuggestion(self.Longtextboxesprefix2+DFMForm.get_TextboxTitle(5))
                    DFMForm.input_actionDetail(self.Longtextboxesprefix2+DFMForm.get_TextboxTitle(6))
                    DFMForm.input_addtionalComments(self.Longtextboxesprefix2+DFMForm.get_TextboxTitle(7))
                    ...
                    assert DFMForm.get_agentOpinion()==self.Longtextboxesprefix2+DFMForm.get_TextboxTitle(2)
                    assert DFMForm.get_leaderSuggestion()==self.Longtextboxesprefix2+DFMForm.get_TextboxTitle(3)
                    assert DFMForm.get_agentImprovement()==self.Longtextboxesprefix2+DFMForm.get_TextboxTitle(4)
                    assert DFMForm.get_improvementSuggestion()==self.Longtextboxesprefix2+DFMForm.get_TextboxTitle(5)
                    assert DFMForm.get_actionDetail()==self.Longtextboxesprefix2+DFMForm.get_TextboxTitle(6)
                    assert DFMForm.get_addtionalComments()==self.Longtextboxesprefix2+DFMForm.get_TextboxTitle(7)
                    assert BasicInfo.get_ButtonName(1)=="Print"
                    ...
                    '''Check16:The  form cannot be edited now.( each field is in uneditable status)
                               ...
                               2.CallRecordingNumber input box is disabled
                               3.All textboxes are disabled'''
                    ...
                    assert DFMForm.agentOpinion_disabled()=="true"
                    assert DFMForm.leaderSuggestion_disabled()=='true'
                    assert DFMForm.improvementSuggestion_disabled()=='true'
                    assert DFMForm.agentImprovement_disabled()=='true'
                    assert DFMForm.actionDetail_disabled()=='true'
                    assert DFMForm.addtionalComments_disabled()=='true'
