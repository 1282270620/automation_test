...
class DirectModelFeedbackProcessConfirmation_PlannedToCanceled(unittest.TestCase):


    def setUp(self):
        #Case ID
        self.caseID="DirectModelFeedbackProcessConfirmation_PlannedToCanceled"
    ...
    def test_Commendation_PlannedToCanceled(self):
        ...
        for i in range(0,len(self.testLOBSITE_list)):
            ...
            if Flag==True:
                ...
                for n in range(0,len(site_list)):
                    ...
                    #Step4:Enter Coaching module.And Open this Direct Model Feedback Process Confirmation coaching form.
                    ...
                    '''Check1:Enter form detail page with title Coaching - Direct Model Feedback Process Confirmation'''
                    ...
                    assert DirectModelFeedbackProcessConfirmationForm.get_comments(3)==''
                    assert DirectModelFeedbackProcessConfirmationForm.get_comments(5)==''
                    assert DirectModelFeedbackProcessConfirmationForm.get_comments(7)==''
                    assert DirectModelFeedbackProcessConfirmationForm.get_comments(9)==''
                    assert DirectModelFeedbackProcessConfirmationForm.get_comments(11)==''
                    assert DirectModelFeedbackProcessConfirmationForm.get_comments(13)==''
                    assert DirectModelFeedbackProcessConfirmationForm.get_comments(14)==''
