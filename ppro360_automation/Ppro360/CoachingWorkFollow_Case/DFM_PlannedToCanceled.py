...
class DFM_PlannedToCanceled(unittest.TestCase):


    def setUp(self):
        #Case ID
        self.caseID="DFM_PlannedToCanceled"
        ...
        for i in range(0,len(self.testLOBSITE_list)):
            ...
            if Flag==True:
                ...
                for n in range(0,len(site_list)):
                    ...
                    '''Check1:Enter form detail page with title Coaching - DFM'''
                    ...
                    assert DFMForm.get_leaderSuggestion()==""
                    assert DFMForm.get_agentImprovement()==""
                    assert DFMForm.get_agentOpinion()==""
                    assert DFMForm.get_actionDetail()==''
                    assert DFMForm.get_improvementSuggestion()==''
                    assert DFMForm.get_addtionalComments()==''
                    ...
                    '''Check8:1.Enter form detail page with title 'Coaching - DFM'
