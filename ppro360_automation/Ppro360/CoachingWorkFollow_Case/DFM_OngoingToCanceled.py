...
class DFM_OngingToCanceled(unittest.TestCase):
    
    
    def setUp(self):
        #Case ID
        self.caseID="DFM_OngoingToCanceled"
        ...
        for i in range(0,len(self.testLOBSITE_list)):
            ...
            if Flag==True:
                ...
                for n in range(0,len(site_list)):
                    ...
                    #for boxindex in range(2,7):
                        #Content_InTextBox=self.Longtextboxesprefix1+DFMForm.get_TextboxTitle(boxindex)
