...
class BehaviorCoachingForm_PlanedToAcknowledged(unittest.TestCase):


    def setUp(self):
        #Case ID
        self.caseID="BehaviorCoachingForm_PlanedToAcknowledged"
    ...
    def test_BehaviorCoachingForm_PlanedToAcknowledged(self):
        ...
        for i in range(0,len(self.testLOBSITE_list)):
            ...
            if Flag==True:
                ...
                for n in range(0,len(site_list)):
                    ...
                    commentsTitle1_new=self.Shorttextboxesprefix2+BehaviorCoachingFormForm.get_firstfourcomments(1)
                    commentsTitle2_new=self.Shorttextboxesprefix2+BehaviorCoachingFormForm.get_firstfourcomments(2)
                    commentsTitle3_new=self.Shorttextboxesprefix2+BehaviorCoachingFormForm.get_firstfourcomments(3)
                    commentsTitle4_new=self.Shorttextboxesprefix2+BehaviorCoachingFormForm.get_firstfourcomments(4)
                    commentsTitle5_new=self.Longtextboxesprefix2+BehaviorCoachingFormForm.get_lastfourcomments(3)
                    commentsTitle6_new=self.Longtextboxesprefix2+BehaviorCoachingFormForm.get_lastfourcomments(4)
                    commentsTitle7_new=self.Longtextboxesprefix2+BehaviorCoachingFormForm.get_lastfourcomments(5)
                    commentsTitle8_new=self.Longtextboxesprefix2+BehaviorCoachingFormForm.get_lastfourcomments(6)
                    ...
                    BehaviorCoachingFormForm.input_firstfourcomments(1,commentsTitle1_new)
                    BehaviorCoachingFormForm.input_firstfourcomments(2,commentsTitle2_new)
                    BehaviorCoachingFormForm.input_firstfourcomments(3,commentsTitle3_new)
                    BehaviorCoachingFormForm.input_firstfourcomments(4,commentsTitle4_new)
                    BehaviorCoachingFormForm.input_lastfourcomments(3,commentsTitle5_new)
                    BehaviorCoachingFormForm.input_lastfourcomments(4,commentsTitle6_new)
                    BehaviorCoachingFormForm.input_lastfourcomments(5,commentsTitle7_new)
                    BehaviorCoachingFormForm.input_lastfourcomments(6,commentsTitle8_new)
                    ...
                    assert BehaviorCoachingFormForm.get_firstfourcomments(1)==commentsTitle1_new
                    assert BehaviorCoachingFormForm.get_firstfourcomments(2)==commentsTitle2_new
                    assert BehaviorCoachingFormForm.get_firstfourcomments(3)==commentsTitle3_new
                    assert BehaviorCoachingFormForm.get_firstfourcomments(4)==commentsTitle4_new
                    assert BehaviorCoachingFormForm.get_lastfourcomments(3)==commentsTitle5_new
                    assert BehaviorCoachingFormForm.get_lastfourcomments(4)==commentsTitle6_new
                    assert BehaviorCoachingFormForm.get_lastfourcomments(5)==commentsTitle7_new
                    assert BehaviorCoachingFormForm.get_lastfourcomments(6)==commentsTitle8_new
                    assert BasicInfo.get_ButtonName(1)=="Print"
