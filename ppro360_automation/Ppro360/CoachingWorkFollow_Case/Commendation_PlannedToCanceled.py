...
class Commendation_PlannedToCanceled(unittest.TestCase):


    def setUp(self):
        #Case ID
        self.caseID="Commendation_PlannedToCanceled"
        ...
        for i in range(0,len(self.testLOBSITE_list)):
            ...
            if Flag==True:
                ...
                for n in range(0,len(site_list)):
                    ...
                    assert CommendationForm.get_callRecordingID()==""
                    assert CommendationForm.get_DateandTimeofCall()==""
                    assert CommendationForm.get_commendation()==""
