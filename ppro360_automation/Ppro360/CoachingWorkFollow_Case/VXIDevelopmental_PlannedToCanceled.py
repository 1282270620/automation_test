...
class VXIDevelopmental_PlannedToCanceled(unittest.TestCase):


    def setUp(self):
        #Case ID
        self.caseID="VXIDevelopmental_PlannedToCanceled"
    ...
    def test_VXIDevelopmental_PlannedToCanceled(self):
        ...
        for i in range(0,len(self.testLOBSITE_list)):
            ...
            if Flag==True:
                ...
                for n in range(0,len(site_list)):
                    ...
                    assert VXIDevelopmentalForm.get_strength()==""
                    assert VXIDevelopmentalForm.get_opportunity()==""
                    assert VXIDevelopmentalForm.get_kpiRelation()==""
                    assert VXIDevelopmentalForm.get_rootCauseAnalysis()==""
                    assert VXIDevelopmentalForm.get_rcaCategory()==""
                    assert VXIDevelopmentalForm.get_actionPlanning()==""
                    assert VXIDevelopmentalForm.get_agentCommitment()==""
                    assert VXIDevelopmentalForm.get_leaderComitment()==""
