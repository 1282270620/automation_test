...
import MySQLdb
from CoachingAndTriadCoaching_Pages.Commendation import Commendation
...
class Commendation_PlanedToAcknowledged(unittest.TestCase):


    def setUp(self):
        #Case ID
        self.caseID="Commendation_PlanedToAcknowledged"
        ...
        #Coachformname
        self.coachformname="Commendation" 
    ...
    def test_Commendation_PlanedToAcknowledged(self):
        ...
        for i in range(0,len(self.testLOBSITE_list)):
            ...
            if Flag==True:
                ...
                for n in range(0,len(site_list)):
                    ...
                    Call_Recording_ID = self.Shorttextboxesprefix1+CommendationForm.get_callRecordingIDBoxTitle()
                    Date_and_Time_of_Call_Input='2016-11-1 12:00AM'
                    call_Recording_Number=self.CallRecordingNumber1
                    CommendationForm.input_callRecordingID(Call_Recording_ID)
                    if lobname != "AOL":
                    ...
                    assert CommendationForm.get_callRecordingID()==Call_Recording_ID
                    assert CommendationForm.get_DateandTimeofCall()==DateandTimeofCall_selected
                    if lobname != "AOL":
                    ...
                    Content_InTextBox=self.Longtextboxesprefix1+CommendationForm.get_commendationBoxTitle()
                    CommendationForm.input_commendation(Content_InTextBox)
                    ...
                    for index in range(6,KPInumber+1):
                        assert BasicInfo.get_anyCheckBoxStatus(index)==self.CheckBox_UnCheckedStatus
                    assert CommendationForm.get_commendation()==Content_InTextBox
                    ...
                    Call_Recording_ID_new =self.Shorttextboxesprefix2+CommendationForm.get_callRecordingIDBoxTitle()
                    ...
                    CommendationForm.input_callRecordingID(Call_Recording_ID_new)
                    CommendationForm.select_anyDateTimeOfCall(1, 2)#select a new date time
                    DateandTimeofCall_selected_new=CommendationForm.get_DateandTimeofCall()
                    if lobname != "AOL":
                        BasicInfo.input_callrecordingnumber(call_Recording_Number_new)
                    CommendationForm.input_commendation(Content_InTextBox_new)
                    ...
                    assert BasicInfo.get_anyCheckBoxStatus(5)==self.CheckBox_CheckedStatus
                    assert DateandTimeofCall_selected!=DateandTimeofCall_selected_new
                    ...
                    assert CommendationForm.get_callRecordingID()==Call_Recording_ID_new
                    assert CommendationForm.get_DateandTimeofCall()==DateandTimeofCall_selected_new
                    assert CommendationForm.get_commendation()==Content_InTextBox_new
                    assert BasicInfo.get_ButtonName(1)=="Print"
                    ...
                    for index in range(6,KPInumber+1):
                        assert BasicInfo.get_anyCheckBoxStatus(index)==self.CheckBox_UnCheckedStatus
                    assert CommendationForm.callRecordingID_disabled()=="true"
                    assert CommendationForm.DateandTimeofCall__disabled()=="true"
                    assert CommendationForm.commendation__disabled()=="true"
