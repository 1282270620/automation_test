...
class AccountabilityConversation_OngoingToCanceled(unittest.TestCase):


    def setUp(self):
        #Case ID
        self.caseID="AccountabilityConversation_OngoingToCanceled"
    ...
    def test_AccountabilityConversation_OngoingToCanceled(self):
        ...
        for i in range(0,len(self.testLOBSITE_list)):
            ...
            if Flag==True:
                ...
                for n in range(0,len(site_list)):
                    ...
                    Content_InTextBox=self.Longtextboxesprefix1+AccountabilityConversationForm.get_evaulateBoxTitle()
                    Content_InTextBox=self.Longtextboxesprefix1+AccountabilityConversationForm.get_checkfuBoxTitle()
                    Content_InTextBox=self.Longtextboxesprefix1+AccountabilityConversationForm.get_iararBoxTitle()
                    Content_InTextBox=self.Longtextboxesprefix1+AccountabilityConversationForm.get_seacBoxTitle()
                    Content_InTextBox=self.Longtextboxesprefix1+AccountabilityConversationForm.get_reconfirmUnderstandingBoxTitle()
                    Content_InTextBox=self.Longtextboxesprefix1+AccountabilityConversationForm.get_otherNotesAndRemarksBoxTitle()
