...
class VXIDevelopmental_PlanedToAcknowledged(unittest.TestCase):


    def setUp(self):
        #Case ID
        self.caseID="VXIDevelopmental_PlanedToAcknowledged"
    ...
    def test_VXIDevelopmental_PlanedToAcknowledged(self):
        ...
        for i in range(0,len(self.testLOBSITE_list)):
            ...
            if Flag==True:
                ...
                for n in range(0,len(site_list)):
                    ...
                    assert VXIDevelopmentalForm.get_callRecordingID()==call_Recording_Number
                    ...
                    strengthBoxTitle_new=self.Longtextboxesprefix2+VXIDevelopmentalForm.get_strengthBoxTitle()
                    opportunityBoxTitle_new=self.Longtextboxesprefix2+VXIDevelopmentalForm.get_opportunityBoxTitle()
                    kpiRelationBoxTitle_new=self.Longtextboxesprefix2+VXIDevelopmentalForm.get_kpiRelationBoxTitle()
                    rootCauseAnalysisBoxTitle_new=self.Longtextboxesprefix2+VXIDevelopmentalForm.get_rootCauseAnalysisBoxTitle()
                    rcaCategoryBoxTitle_new=self.Shorttextboxesprefix2+VXIDevelopmentalForm.get_rcaCategoryBoxTitle()
                    actionPlanningBoxTitle_new=self.Longtextboxesprefix2+VXIDevelopmentalForm.get_actionPlanningBoxTitle()
                    agentCommitmentBoxTitle_new=self.Longtextboxesprefix2+VXIDevelopmentalForm.get_agentCommitmentBoxTitle()
                    leaderComitmentBoxTitle_new=self.Longtextboxesprefix2+VXIDevelopmentalForm.get_leaderComitmentBoxTitle()
                    ...
                    VXIDevelopmentalForm.input_strength(strengthBoxTitle_new)
                    VXIDevelopmentalForm.input_opportunity(opportunityBoxTitle_new)
                    VXIDevelopmentalForm.input_kpiRelation(kpiRelationBoxTitle_new)
                    VXIDevelopmentalForm.input_rootCauseAnalysis(rootCauseAnalysisBoxTitle_new)
                    VXIDevelopmentalForm.input_rcaCategory(rcaCategoryBoxTitle_new)
                    VXIDevelopmentalForm.input_actionPlanning(actionPlanningBoxTitle_new)
                    VXIDevelopmentalForm.input_agentCommitment(agentCommitmentBoxTitle_new)
                    VXIDevelopmentalForm.input_leaderComitment(leaderComitmentBoxTitle_new)
                    ...
                    assert VXIDevelopmentalForm.get_strength()==strengthBoxTitle_new
                    assert VXIDevelopmentalForm.get_opportunity()==opportunityBoxTitle_new
                    assert VXIDevelopmentalForm.get_kpiRelation()==kpiRelationBoxTitle_new
                    assert VXIDevelopmentalForm.get_rootCauseAnalysis()==rootCauseAnalysisBoxTitle_new
                    assert VXIDevelopmentalForm.get_rcaCategory()==rcaCategoryBoxTitle_new
                    assert VXIDevelopmentalForm.get_actionPlanning()==actionPlanningBoxTitle_new
                    assert VXIDevelopmentalForm.get_agentCommitment()==agentCommitmentBoxTitle_new
                    assert VXIDevelopmentalForm.get_leaderComitment()==leaderComitmentBoxTitle_new
                    assert BasicInfo.get_ButtonName(1)=="Print"
