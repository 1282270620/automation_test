...
from CoachingAndTriadCoaching_Pages.DirectModelFeedbackProcessConfirmation import DirectModelFeedbackProcessConfirmation
...
class DirectModelFeedbackProcessConfirmation_PlannedToAcknowledged(unittest.TestCase):


    def setUp(self):
        #Case ID
        self.caseID="DirectModelFeedbackProcessConfirmation_PlannedToAcknowledged"
        ...
        #Coachformname
        self.coachformname="Direct Model Feedback Process Confirmation" 
    ...
    def test_CoachingLoopProcessConfirmation_PlanedToAcknowledged(self):
        ...
        Header=HeaderPage()
        DirectModelFeedbackProcessConfirmationForm=DirectModelFeedbackProcessConfirmation()
        ...
        for i in range(0,len(self.testLOBSITE_list)):
            ...
            if Flag==True:
                ...
                for n in range(0,len(site_list)):
                    ...
                    '''Check2:1.Page title :'Coaching - Direct Model Feedback Process Confirmation'.
                    ...
                    CoachHome.click_eachcoach(1)
                    '''Check7:Enter the  form detail page with title 'Coaching - Direct Model Feedback Process Confirmation'''
                    assert Header.get_HeaderTittle()==self.coachpagetitle 
                    
                    #Step3.8:Input content in following editable fields:
                            #1.Uncheck the third KPI;
                            #2.Check the fourth KPI.;
                    ...
                    DirectModelFeedbackProcessConfirmationForm.input_comments(self.Longtextboxesprefix1+DirectModelFeedbackProcessConfirmationForm.get_TextboxTitle(3), 3)                   
                    DirectModelFeedbackProcessConfirmationForm.input_comments(self.Longtextboxesprefix1+DirectModelFeedbackProcessConfirmationForm.get_TextboxTitle(5), 5)                    
                    DirectModelFeedbackProcessConfirmationForm.input_comments(self.Longtextboxesprefix1+DirectModelFeedbackProcessConfirmationForm.get_TextboxTitle(7), 7)                 
                    DirectModelFeedbackProcessConfirmationForm.input_comments(self.Longtextboxesprefix1+DirectModelFeedbackProcessConfirmationForm.get_TextboxTitle(9), 9)                  
                    DirectModelFeedbackProcessConfirmationForm.input_comments(self.Longtextboxesprefix1+DirectModelFeedbackProcessConfirmationForm.get_TextboxTitle(11), 11)                    
                    DirectModelFeedbackProcessConfirmationForm.input_comments(self.Longtextboxesprefix1+DirectModelFeedbackProcessConfirmationForm.get_TextboxTitle(13), 13)                   
                    DirectModelFeedbackProcessConfirmationForm.input_comments(self.Longtextboxesprefix1+DirectModelFeedbackProcessConfirmationForm.get_TextboxTitle(14), 14)
                    ...
                    #Step3.12:Open this record  form again.
                    #CoachHome.click_eachcoach(typename_path)
                    CoachHome.click_eachcoach(1)
                    ...
                    for index in range(6,KPInumber+1):
                        assert BasicInfo.get_anyCheckBoxStatus(index)==self.CheckBox_UnCheckedStatus   
                    assert DirectModelFeedbackProcessConfirmationForm.get_comments(3)==self.Longtextboxesprefix1+DirectModelFeedbackProcessConfirmationForm.get_TextboxTitle(3)                     
                    assert DirectModelFeedbackProcessConfirmationForm.get_comments(5)==self.Longtextboxesprefix1+DirectModelFeedbackProcessConfirmationForm.get_TextboxTitle(5)                    
                    assert DirectModelFeedbackProcessConfirmationForm.get_comments(7)==self.Longtextboxesprefix1+DirectModelFeedbackProcessConfirmationForm.get_TextboxTitle(7)                   
                    assert DirectModelFeedbackProcessConfirmationForm.get_comments(9)==self.Longtextboxesprefix1+DirectModelFeedbackProcessConfirmationForm.get_TextboxTitle(9)                   
                    assert DirectModelFeedbackProcessConfirmationForm.get_comments(11)==self.Longtextboxesprefix1+DirectModelFeedbackProcessConfirmationForm.get_TextboxTitle(11)                      
                    assert DirectModelFeedbackProcessConfirmationForm.get_comments(13)==self.Longtextboxesprefix1+DirectModelFeedbackProcessConfirmationForm.get_TextboxTitle(13)
                    assert DirectModelFeedbackProcessConfirmationForm.get_comments(14)==self.Longtextboxesprefix1+DirectModelFeedbackProcessConfirmationForm.get_TextboxTitle(14)
                    
                    #Step3.13:1.Change content in all editable fields to new one:
                            #1)Unchecked the first two KPIs,Check the third KPI
                            #2)input call Recording Number
                            #3)in all other text boxes:Edit content, performance pro test team to input content in text boxes ,alice_shu0823~!@#$%^&*();:'"?/\[]{},sabrina's@symbio.com.
                    ...
                    DirectModelFeedbackProcessConfirmationForm.input_comments(self.Longtextboxesprefix2+DirectModelFeedbackProcessConfirmationForm.get_TextboxTitle(3), 3)                   
                    DirectModelFeedbackProcessConfirmationForm.input_comments(self.Longtextboxesprefix2+DirectModelFeedbackProcessConfirmationForm.get_TextboxTitle(5), 5)                    
                    DirectModelFeedbackProcessConfirmationForm.input_comments(self.Longtextboxesprefix2+DirectModelFeedbackProcessConfirmationForm.get_TextboxTitle(7), 7)                 
                    DirectModelFeedbackProcessConfirmationForm.input_comments(self.Longtextboxesprefix2+DirectModelFeedbackProcessConfirmationForm.get_TextboxTitle(9), 9)                  
                    DirectModelFeedbackProcessConfirmationForm.input_comments(self.Longtextboxesprefix2+DirectModelFeedbackProcessConfirmationForm.get_TextboxTitle(11), 11)                    
                    DirectModelFeedbackProcessConfirmationForm.input_comments(self.Longtextboxesprefix2+DirectModelFeedbackProcessConfirmationForm.get_TextboxTitle(13), 13)                   
                    DirectModelFeedbackProcessConfirmationForm.input_comments(self.Longtextboxesprefix2+DirectModelFeedbackProcessConfirmationForm.get_TextboxTitle(14), 14)
                    ...
                    #Step3.13:2.Click  button "Complete Coaching";
                    ...
                    assert DirectModelFeedbackProcessConfirmationForm.get_comments(3)==self.Longtextboxesprefix2+DirectModelFeedbackProcessConfirmationForm.get_TextboxTitle(3)                     
                    assert DirectModelFeedbackProcessConfirmationForm.get_comments(5)==self.Longtextboxesprefix2+DirectModelFeedbackProcessConfirmationForm.get_TextboxTitle(5)                    
                    assert DirectModelFeedbackProcessConfirmationForm.get_comments(7)==self.Longtextboxesprefix2+DirectModelFeedbackProcessConfirmationForm.get_TextboxTitle(7)                   
                    assert DirectModelFeedbackProcessConfirmationForm.get_comments(9)==self.Longtextboxesprefix2+DirectModelFeedbackProcessConfirmationForm.get_TextboxTitle(9)                   
                    assert DirectModelFeedbackProcessConfirmationForm.get_comments(11)==self.Longtextboxesprefix2+DirectModelFeedbackProcessConfirmationForm.get_TextboxTitle(11)                      
                    assert DirectModelFeedbackProcessConfirmationForm.get_comments(13)==self.Longtextboxesprefix2+DirectModelFeedbackProcessConfirmationForm.get_TextboxTitle(13)
                    assert DirectModelFeedbackProcessConfirmationForm.get_comments(14)==self.Longtextboxesprefix2+DirectModelFeedbackProcessConfirmationForm.get_TextboxTitle(14)   
                    ...
                    assert DirectModelFeedbackProcessConfirmationForm.Comments_disabled(3)=='true'
                    assert DirectModelFeedbackProcessConfirmationForm.Comments_disabled(5)=='true'
                    assert DirectModelFeedbackProcessConfirmationForm.Comments_disabled(7)=='true'
                    assert DirectModelFeedbackProcessConfirmationForm.Comments_disabled(9)=='true'
                    assert DirectModelFeedbackProcessConfirmationForm.Comments_disabled(11)=='true'
                    assert DirectModelFeedbackProcessConfirmationForm.Comments_disabled(13)=='true'
                    assert DirectModelFeedbackProcessConfirmationForm.Comments_disabled(14)=='true'
                    ...
                    '''Check18:1.This  form record should be in the list
                               2. Enter the  form detail page with title 'Coaching - Direct Model Feedback Process Confirmation' On this form:1)Status = Completed; 2)Completed Date = The date when the form is completed;3)Acknowledged Date=blank
                    ...
                    '''Check24:1.The  form is searched out with status shown 'acknowledged ';
                               2.Enter the  form detail page with title 'Coaching - DirectModel Feedback Process Confirmation';
