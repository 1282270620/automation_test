...
class SettingExpectations_PlannedToCanceled(unittest.TestCase):


    def setUp(self):
        #Case ID
        self.caseID="SettingExpectations_PlannedToCanceled"
    ...
    def test_SettingExpectations_PlannedToCanceled(self):
        ...
        for i in range(0,len(self.testLOBSITE_list)):
            ...
            if Flag==True:
                ...
                for n in range(0,len(site_list)):
                    ...
                    #Step4:Enter Coaching module.And Open this Setting Expectations coaching form.
                    ...
                    '''Check1:Enter form detail page with title Coaching - Setting Expectations'''
                    assert Header.get_HeaderTittle()==self.coachpagetitle
                    
                    #Step5:Click button "Cancel Coaching"
                    BasicInfo.Click_Button(4)
                    '''Check2: 1.Pop up window with  title 'Setting Expectations'.
                    ...
                    assert SettingExpectationsForm.get_establishExpectation()==""
                    assert SettingExpectationsForm.get_reason()==""
                    assert SettingExpectationsForm.get_resources()==""
                    assert SettingExpectationsForm.get_verifyUnderstanding()==""
                    assert SettingExpectationsForm.get_verifyCommitment()==""
                    assert SettingExpectationsForm.get_confidenceBuilder()==""
                    assert SettingExpectationsForm.get_otherNotesAndRemarks()==""
                    ...
                    '''Check8:1.Enter form detail page with title 'Coaching - Setting Expectations'
