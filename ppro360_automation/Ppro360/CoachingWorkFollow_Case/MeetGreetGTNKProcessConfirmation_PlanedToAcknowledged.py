...
class MeetGreetGTNKProcessConfirmation_PlanedToAcknowledged(unittest.TestCase):


    def setUp(self):
        #Case ID
        self.caseID="MeetGreetGTNKProcessConfirmation_PlanedToAcknowledged"
    ...
    def test_MeetGreetGTNKProcessConfirmation_PlanedToAcknowledged(self):
        ...
        for i in range(0,len(self.testLOBSITE_list)):
            ...
            if Flag==True:
                ...
                for n in range(0,len(site_list)):
                    ...
                    #CoachHome.click_eachcoach(typename_path)
                    CoachHome.click_eachcoach(1)
                    '''Check7:Enter the  form detail page with title 'Coaching - Commendation'''
                    assert Header.get_HeaderTittle()==self.coachpagetitle 
                    ...
                    #Step3.9:1.Input Call Recording ID ='callRecordingID_001&002'
                    ...
                    #CommendationForm.input_DateandTimeofCall(Date_and_Time_of_Call_Input)
                    ...
                    #assert CommendationForm.get_DateandTimeofCall()==""#Date and time of Call'  cannot be manually inputted.
                    #CommendationForm.select_anyDateTimeOfCall(1,1)
                    #DateandTimeofCall_selected=CommendationForm.get_DateandTimeofCall()
                    ...
                    commentsTitle1=self.Longtextboxesprefix1+MeetGreetGTNKProcessConfirmationForm.get_commentsBoxTitle(3)
                    commentsTitle2=self.Longtextboxesprefix1+MeetGreetGTNKProcessConfirmationForm.get_commentsBoxTitle(5)
                    commentsTitle3=self.Longtextboxesprefix1+MeetGreetGTNKProcessConfirmationForm.get_commentsBoxTitle(7)
                    commentsTitle4=self.Longtextboxesprefix1+MeetGreetGTNKProcessConfirmationForm.get_commentsBoxTitle(9)
                    commentsTitle5=self.Longtextboxesprefix1+MeetGreetGTNKProcessConfirmationForm.get_commentsBoxTitle(11)
                    commentsTitle6=self.Longtextboxesprefix1+MeetGreetGTNKProcessConfirmationForm.get_commentsBoxTitle(13)
                    commentsTitle7=self.Longtextboxesprefix1+MeetGreetGTNKProcessConfirmationForm.get_commentsBoxTitle(14)
                    #input text and title id 
                    MeetGreetGTNKProcessConfirmationForm.input_comments(3,commentsTitle1)
                    MeetGreetGTNKProcessConfirmationForm.input_comments(5,commentsTitle2)
                    MeetGreetGTNKProcessConfirmationForm.input_comments(7,commentsTitle3)
                    MeetGreetGTNKProcessConfirmationForm.input_comments(9,commentsTitle4)
                    MeetGreetGTNKProcessConfirmationForm.input_comments(11,commentsTitle5)
                    MeetGreetGTNKProcessConfirmationForm.input_comments(13,commentsTitle6)
                    MeetGreetGTNKProcessConfirmationForm.input_comments(14,commentsTitle7)
                    ...
                    for index in range(6,KPInumber+1):
                        assert BasicInfo.get_anyCheckBoxStatus(index)==self.CheckBox_UnCheckedStatus
                    assert MeetGreetGTNKProcessConfirmationForm.get_comments(3)==commentsTitle1
                    assert MeetGreetGTNKProcessConfirmationForm.get_comments(5)==commentsTitle2
                    assert MeetGreetGTNKProcessConfirmationForm.get_comments(7)==commentsTitle3
                    assert MeetGreetGTNKProcessConfirmationForm.get_comments(9)==commentsTitle4
                    assert MeetGreetGTNKProcessConfirmationForm.get_comments(11)==commentsTitle5
                    assert MeetGreetGTNKProcessConfirmationForm.get_comments(13)==commentsTitle6
                    assert MeetGreetGTNKProcessConfirmationForm.get_comments(14)==commentsTitle7
                    ...
                    commentsTitle1_new=self.Longtextboxesprefix2+MeetGreetGTNKProcessConfirmationForm.get_commentsBoxTitle(3)
                    commentsTitle2_new=self.Longtextboxesprefix2+MeetGreetGTNKProcessConfirmationForm.get_commentsBoxTitle(5)
                    commentsTitle3_new=self.Longtextboxesprefix2+MeetGreetGTNKProcessConfirmationForm.get_commentsBoxTitle(7)
                    commentsTitle4_new=self.Longtextboxesprefix2+MeetGreetGTNKProcessConfirmationForm.get_commentsBoxTitle(9)
                    commentsTitle5_new=self.Longtextboxesprefix2+MeetGreetGTNKProcessConfirmationForm.get_commentsBoxTitle(11)
                    commentsTitle6_new=self.Longtextboxesprefix2+MeetGreetGTNKProcessConfirmationForm.get_commentsBoxTitle(13)
                    commentsTitle7_new=self.Longtextboxesprefix2+MeetGreetGTNKProcessConfirmationForm.get_commentsBoxTitle(14)
                    ...
                    MeetGreetGTNKProcessConfirmationForm.input_comments(3,commentsTitle1_new)
                    MeetGreetGTNKProcessConfirmationForm.input_comments(5,commentsTitle2_new)
                    MeetGreetGTNKProcessConfirmationForm.input_comments(7,commentsTitle3_new)
                    MeetGreetGTNKProcessConfirmationForm.input_comments(9,commentsTitle4_new)
                    MeetGreetGTNKProcessConfirmationForm.input_comments(11,commentsTitle5_new)
                    MeetGreetGTNKProcessConfirmationForm.input_comments(13,commentsTitle6_new)
                    MeetGreetGTNKProcessConfirmationForm.input_comments(14,commentsTitle7_new)
                    ...
                    assert MeetGreetGTNKProcessConfirmationForm.get_comments(3)==commentsTitle1_new
                    assert MeetGreetGTNKProcessConfirmationForm.get_comments(5)==commentsTitle2_new
                    assert MeetGreetGTNKProcessConfirmationForm.get_comments(7)==commentsTitle3_new
                    assert MeetGreetGTNKProcessConfirmationForm.get_comments(9)==commentsTitle4_new
                    assert MeetGreetGTNKProcessConfirmationForm.get_comments(11)==commentsTitle5_new
                    assert MeetGreetGTNKProcessConfirmationForm.get_comments(13)==commentsTitle6_new
                    assert MeetGreetGTNKProcessConfirmationForm.get_comments(14)==commentsTitle7_new
                    assert BasicInfo.get_ButtonName(1)=="Print"
