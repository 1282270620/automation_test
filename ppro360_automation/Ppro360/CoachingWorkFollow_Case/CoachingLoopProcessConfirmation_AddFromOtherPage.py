...
class CoachingLoopProcessConfirmation_AddFromOtherPage(unittest.TestCase):


    def setUp(self):
        #Case ID
        self.caseID="CoachingLoopProcessConfirmation_AddFromOtherPage"
            ...
            if Flag==True:
                ...
                for n in range(0,len(site_list)):
                    ...
                    for ywm in range(0,len(tablist)):
                        ...
                        '''Check1&2:1.Enter the  form detail page with title 'Coaching - Coaching Loop Process Confirmation'
            ...
            if Flag==True:
                ...
                for n in range(0,len(site_list)):
                    ...
                    for ywm in range(0,len(tablist_3)):
                        ...
                        '''Check_Month-To-Date:
                                 1) Enter this form detail page with title 'Coaching - Coaching Loop Process Confirmation'
                        ...
                        print BasicInfo.get_anyCheckBoxStatus_Agent(KPInumber_CoachDetail),self.CheckBox_CheckedStatus
