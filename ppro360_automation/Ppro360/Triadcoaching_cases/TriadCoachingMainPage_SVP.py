...
class TriadCoachingMainPage_SVP(unittest.TestCase):
    '''
    classdocs
    '''
    def setUp(self):
    ...
    def test_TriadCoachingMainPage_SVP(self):
        ...
        for i in range(0,len(self.testLOBSITE_list)):
            ...
            if Flag==True:
                ...
                for n in range(0,len(site_list)):
                    ...
                    sql_coach="select * from coach  where classification=1 and (status in (0, 3)) order by id desc;"
