...
class TriadCoachingMainPage_LC(unittest.TestCase):
    '''
    classdocs
    '''
    def setUp(self):
        #Case ID
        self.caseID="TriadCoachingMainPage_LC"
    ...
    def test_TriadCoachingMainPage_LC(self):
        ...
        for i in range(0,len(self.testLOBSITE_list)):
            ...
            if Flag==True:
                ...
                for n in range(0,len(site_list)):
                    ...
                    sql_coach="select * from coach  where classification=1 and assign_to_id="+self.LCuserid+" and (status in (0, 3)) order by id desc;"
