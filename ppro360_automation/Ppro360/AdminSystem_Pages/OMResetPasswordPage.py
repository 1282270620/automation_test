...
class OMResetPasswordPage(BasePage.Action):
    '''
    classdocs
    '''
    ...
    def __init__(self):
        ...
        self.ResetPasswordbutton_loc=(By.XPATH,"/html/body/div[2]/div/div[2]/div/div/div[5]/div[2]/a")
    ...
    def click_ResetPWDbutton(self):
        self.find_element(*self.ResetPasswordbutton_loc).click()
    ...
    def firstnameInput_disabled(self):
        return self.find_element(*self.firstnameInput_loc).get_attribute("disabled")
    
    def lastnameInput_disabled(self):
        return self.find_element(*self.lastnameInput_loc).get_attribute("disabled")
    ...
    def SaveButton_disabled(self):
        return self.find_element(*self.Savebutton_loc).get_attribute("class")
    def CancelButton_disabled(self):
        return self.find_element(*self.Cancelbutton_loc).get_attribute("class")
