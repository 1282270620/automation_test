...
from CoachingAndTriadCoaching_Pages.RapidFireProcessConfirmation import RapidFireProcessConfirmation
...
class RapidFireProcessConfirmation_PlannedToCompleted(unittest.TestCase):


    def setUp(self):
        #Case ID
        self.caseID="RapidFireProcessConfirmation_PlannedToCompleted"
        ...
        self.coachformname="Rapid Fire Process Confirmation" 
    ...
    def test_RapidFireProcessConfirmation_PlannedToCanceled(self):
        ...
        Header=HeaderPage()
        RapidFireProcessConfirmationForm=RapidFireProcessConfirmation()
        ...
        for i in range(0,len(self.testLOBSITE_list)):
            ...
            if Flag==True:
                ...
                for n in range(0,len(site_list)):
                    ...
                    assert RapidFireProcessConfirmationForm.overallscore_disabled()=="true"
                    assert RapidFireProcessConfirmationForm.get_overallscore()=="0"
                    ...
                    while a<16:
                                a=a+2
                                assert RapidFireProcessConfirmationForm.scoreinput_disabled(a)=="true"
                    a1=1
                    while a1<17:
                                a1=a1+2    
                                assert RapidFireProcessConfirmationForm.comments_disabled(a1)=="true"
                    ...
                    number3="3"
                    number4="2.33"
                    RapidFireProcessConfirmationForm.input_scoreinput(2,number2)
                    RapidFireProcessConfirmationForm.input_scoreinput(6,number2)
                    RapidFireProcessConfirmationForm.input_scoreinput(10,number3)
                    b=1
                    while b<17:
                        b=b+2
                        commentsBoxtitle2=self.Longtextboxesprefix1+RapidFireProcessConfirmationForm.get_commentsBoxtitle(b)
                        RapidFireProcessConfirmationForm.input_comments(b,commentsBoxtitle2)
                    ...
                    assert RapidFireProcessConfirmationForm.get_overallscore()==number4
                    assert RapidFireProcessConfirmationForm.get_overallballstataus()==self.yellowball
                    assert RapidFireProcessConfirmationForm.get_scoreinput(2)==number2
                    assert RapidFireProcessConfirmationForm.get_scoreinput(6)==number2
                    assert RapidFireProcessConfirmationForm.get_scoreinput(10)==number3
                    assert RapidFireProcessConfirmationForm.get_scoreballstataus(2)==self.yellowball
                    assert RapidFireProcessConfirmationForm.get_scoreballstataus(6)==self.yellowball
                    assert RapidFireProcessConfirmationForm.get_scoreballstataus(10)==self.greenball
                     
                    c=1
                    while c<17:
                        c=c+2
                        commentsBoxtitle2=self.Longtextboxesprefix1+RapidFireProcessConfirmationForm.get_commentsBoxtitle(c)
                        assert RapidFireProcessConfirmationForm.get_comments(c)==commentsBoxtitle2
