...
from CoachingAndTriadCoaching_Pages.CustomerExperienceImprovementCalibration import CustomerExperienceImprovementCalibration
...
class CustomerExperienceImprovementCalibration_PlannedToCompleted(unittest.TestCase):


    def setUp(self):
        #Case ID
        self.caseID="CustomerExperienceImprovementCalibration_PlannedToCompleted"
        ...
        self.coachformname="Customer Experience Improvement Calibration" 
    ...
    def test_CustomerExperienceImprovementCalibration_PlannedToCanceled(self):
        ...
        Header=HeaderPage()
        CustomerExperienceImprovementCalibrationForm=CustomerExperienceImprovementCalibration()
        ...
        for i in range(0,len(self.testLOBSITE_list)):
            ...
            if Flag==True:
                ...
                for n in range(0,len(site_list)):
                    ...
                    assert CustomerExperienceImprovementCalibrationForm.lasttwoinput_disabled(3)=="true"
                    assert CustomerExperienceImprovementCalibrationForm.lasttwoinput_disabled(4)=="true"
                    a=0
                    while a<6:
                                a=a+1
                                assert CustomerExperienceImprovementCalibrationForm.selectbotton_disabled(a)=="true"
                                b=2
                                while b<4:
                                    b=b+1
                                    assert CustomerExperienceImprovementCalibrationForm.midinput_disabled(a,b)=="true"
                    ...
                    longcommentsBoxtitle1=self.Longtextboxesprefix1+CustomerExperienceImprovementCalibrationForm.get_lasttwoinputBoxtitle(3)
                    longcommentsBoxtitle2=self.Longtextboxesprefix1+CustomerExperienceImprovementCalibrationForm.get_lasttwoinputBoxtitle(4)
                    select1="N/A"
                    select2="1"
                    select3="2"
                    select4="3"
                    ...
                    if lobname != "AOL":
                        BasicInfo.input_callrecordingnumber(CallRecordingNumber)
                    CustomerExperienceImprovementCalibrationForm.input_lasttwoinput(3, longcommentsBoxtitle1)
                    CustomerExperienceImprovementCalibrationForm.input_lasttwoinput(4, longcommentsBoxtitle2)
                    a1=0
                    while a1<6:
                        a1=a1+1
                        CustomerExperienceImprovementCalibrationForm.click_selectbotton(a1)
                        CustomerExperienceImprovementCalibrationForm.click_scorechoose(a1, a1)
                        b1=2
                        while b1<4:
                            b1=b1+1
                            midinput=self.Shorttextboxesprefix1+CustomerExperienceImprovementCalibrationForm.get_midinputBoxtitle(a1)
                            CustomerExperienceImprovementCalibrationForm.input_midinput( a1, b1, midinput)
                    ...
                    assert CustomerExperienceImprovementCalibrationForm.get_lasttwoinput(3)==longcommentsBoxtitle1
                    assert CustomerExperienceImprovementCalibrationForm.get_lasttwoinput(4)==longcommentsBoxtitle2
                    a2=0
                    while a2<6:
                        a2=a2+1
                        b2=2
                        while b2<4:
                            b2=b2+1
                            midinput2=self.Shorttextboxesprefix1+CustomerExperienceImprovementCalibrationForm.get_midinputBoxtitle(a2)
                            assert CustomerExperienceImprovementCalibrationForm.get_midinput(a2, b2)==midinput2
                    look=CustomerExperienceImprovementCalibrationForm.get_selectbottonvalue(1)
                    print look
                    assert CustomerExperienceImprovementCalibrationForm.get_selectbottonvalue(1)==select1
                    assert CustomerExperienceImprovementCalibrationForm.get_selectbottonvalue(2)==select2
                    assert CustomerExperienceImprovementCalibrationForm.get_selectbottonvalue(3)==select3
                    assert CustomerExperienceImprovementCalibrationForm.get_selectbottonvalue(4)==select4
                    assert CustomerExperienceImprovementCalibrationForm.get_selectbottonvalue(5)==select5
                    assert CustomerExperienceImprovementCalibrationForm.get_selectbottonvalue(6)==select6
