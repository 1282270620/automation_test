...
from CoachingAndTriadCoaching_Pages.AgentHuddleProcessConfirmation import AgentHuddleProcessConfirmation
...
class AgentHuddleProcessConfirmation_PlannedToCompleted(unittest.TestCase):


    def setUp(self):
        #Case ID
        self.caseID="AgentHuddleProcessConfirmation_PlannedToCompleted"
        ...
        self.coachformname="Agent Huddle Process Confirmation" 
    ...
    def test_AgentHuddleProcessConfirmation_PlannedToCanceled(self):
        ...
        Header=HeaderPage()
        AgentHuddleProcessConfirmationForm=AgentHuddleProcessConfirmation()
        ...
        for i in range(0,len(self.testLOBSITE_list)):
            ...
            if Flag==True:
                ...
                for n in range(0,len(site_list)):
                    ...
                    assert AgentHuddleProcessConfirmationForm.specialtopic_disabled()=="true"
                    assert AgentHuddleProcessConfirmationForm.lastthreeinput_disabled(2)=="true"
                    assert AgentHuddleProcessConfirmationForm.lastthreeinput_disabled(3)=="true"
                    assert AgentHuddleProcessConfirmationForm.lastthreeinput_disabled(4)=="true"
                    f=2
                    while f<10:
                                f=f+2
                                assert AgentHuddleProcessConfirmationForm.otherinput_disabled(f)=="true"
                                
                    f1=11
                    while f1<19:
                                f1=f1+2
                                assert AgentHuddleProcessConfirmationForm.otherinput_disabled(f1)=="true"
                    f2=20
                    while f2<24:
                                f2=f2+2
                                assert AgentHuddleProcessConfirmationForm.otherinput_disabled(f2)=="true"
                    f3=25
                    while f3<39:
                                f3=f3+2
                                assert AgentHuddleProcessConfirmationForm.otherinput_disabled(f3)=="true"
                    a=1
                    while a<9:
                                a=a+2
                                assert AgentHuddleProcessConfirmationForm.get_chooseclickStataus(a,1)==self.CheckBox_UnCheckedStatus2
                                assert AgentHuddleProcessConfirmationForm.get_chooseclickStataus(a,2)==self.CheckBox_UnCheckedStatus2

                    
                    a1=10
                    while a1<18:
                                a1=a1+2
                                assert AgentHuddleProcessConfirmationForm.get_chooseclickStataus(a1,1)==self.CheckBox_UnCheckedStatus2
                                assert AgentHuddleProcessConfirmationForm.get_chooseclickStataus(a1,2)==self.CheckBox_UnCheckedStatus2

                                
                    a2=19
                    while a2<21:
                                a2=a2+2
                                assert AgentHuddleProcessConfirmationForm.get_chooseclickStataus(a2,1)==self.CheckBox_UnCheckedStatus2
                                assert AgentHuddleProcessConfirmationForm.get_chooseclickStataus(a2,2)==self.CheckBox_UnCheckedStatus2
                    ...
                    while a3<38:
                                a3=a3+2
                                assert AgentHuddleProcessConfirmationForm.get_chooseclickStataus(a3,1)==self.CheckBox_UnCheckedStatus2
                                assert AgentHuddleProcessConfirmationForm.get_chooseclickStataus(a3,2)==self.CheckBox_UnCheckedStatus2
                    ...
                    specialtopicBoxTitle=self.Longtextboxesprefix1+AgentHuddleProcessConfirmationForm.get_specialtopicBoxTitle()
                    lastthreeinputBoxTitle2=self.Longtextboxesprefix1+AgentHuddleProcessConfirmationForm.get_lastthreeinputBoxTitle(2)
                    lastthreeinputBoxTitle3=self.Longtextboxesprefix1+AgentHuddleProcessConfirmationForm.get_lastthreeinputBoxTitle(3)
                    lastthreeinputBoxTitle4=self.Longtextboxesprefix1+AgentHuddleProcessConfirmationForm.get_lastthreeinputBoxTitle(4)
                    ...
                    if lobname != "AOL":
                        BasicInfo.input_callrecordingnumber(CallRecordingNumber)
                    AgentHuddleProcessConfirmationForm.input_lastthreeinput(2,lastthreeinputBoxTitle2)
                    AgentHuddleProcessConfirmationForm.input_lastthreeinput(3,lastthreeinputBoxTitle3)
                    AgentHuddleProcessConfirmationForm.input_lastthreeinput(4,lastthreeinputBoxTitle4)
                    AgentHuddleProcessConfirmationForm.input_specialtopic(specialtopicBoxTitle)
                    b=2
                    while b<10:
                                b=b+2
                                otherinputBoxTitle=self.Longtextboxesprefix1+AgentHuddleProcessConfirmationForm.get_otherinputBoxTitle(b)
                                AgentHuddleProcessConfirmationForm.input_otherinput(b,otherinputBoxTitle)
                                
                                
                    b1=11
                    while b1<19:
                                b1=b1+2
                                otherinputBoxTitle=self.Longtextboxesprefix1+AgentHuddleProcessConfirmationForm.get_otherinputBoxTitle(b1)
                                AgentHuddleProcessConfirmationForm.input_otherinput(b1,otherinputBoxTitle)
                    ...
                    while b2<24:
                                b2=b2+2
                                otherinputBoxTitle=self.Longtextboxesprefix1+AgentHuddleProcessConfirmationForm.get_otherinputBoxTitle(b2)
                                AgentHuddleProcessConfirmationForm.input_otherinput(b2,otherinputBoxTitle)
                    ...
                    while b3<39:
                                b3=b3+2
                                otherinputBoxTitle=self.Longtextboxesprefix1+AgentHuddleProcessConfirmationForm.get_otherinputBoxTitle(b3)
                                AgentHuddleProcessConfirmationForm.input_otherinput(b3,otherinputBoxTitle)
                                
                        
                    c=1
                    while c<9:
                        c=c+2
                        AgentHuddleProcessConfirmationForm.click_chooseclick(c,2)
                    ...
                    assert AgentHuddleProcessConfirmationForm.get_lastthreeinput(2)==lastthreeinputBoxTitle2
                    assert AgentHuddleProcessConfirmationForm.get_lastthreeinput(3)==lastthreeinputBoxTitle3
                    assert AgentHuddleProcessConfirmationForm.get_lastthreeinput(4)==lastthreeinputBoxTitle4  
                    d=1
                    while d<9:
                            d=d+2
                            assert AgentHuddleProcessConfirmationForm.get_chooseclickStataus(d,1)==self.CheckBox_UnCheckedStatus2
                            assert AgentHuddleProcessConfirmationForm.get_chooseclickStataus(d,2)==self.CheckBox_CheckedStatus2
                            
                    e=2
                    while e<10:
                                e=e+2
                                otherinputBoxTitle=self.Longtextboxesprefix1+AgentHuddleProcessConfirmationForm.get_otherinputBoxTitle(e)
                                assert AgentHuddleProcessConfirmationForm.get_otherinput(e)==otherinputBoxTitle
                                
                                
                    e1=11
                    while e1<19:
                                e1=e1+2
                                otherinputBoxTitle=self.Longtextboxesprefix1+AgentHuddleProcessConfirmationForm.get_otherinputBoxTitle(e1)
                                assert AgentHuddleProcessConfirmationForm.get_otherinput(e1)==otherinputBoxTitle
                    ...
                    while e2<24:
                                e2=e2+2
                                otherinputBoxTitle=self.Longtextboxesprefix1+AgentHuddleProcessConfirmationForm.get_otherinputBoxTitle(e2)
                                assert AgentHuddleProcessConfirmationForm.get_otherinput(e2)==otherinputBoxTitle
                    ...
                    while e3<39:
                                e3=e3+2
                                otherinputBoxTitle=self.Longtextboxesprefix1+AgentHuddleProcessConfirmationForm.get_otherinputBoxTitle(e3)
                                assert AgentHuddleProcessConfirmationForm.get_otherinput(e3)==otherinputBoxTitle
