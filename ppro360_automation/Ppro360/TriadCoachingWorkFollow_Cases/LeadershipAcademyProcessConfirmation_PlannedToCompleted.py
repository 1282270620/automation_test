...
from CoachingAndTriadCoaching_Pages.LeadershipAcademyProcessConfirmation import LeadershipAcademyProcessConfirmation
from Tablet_pages.HeaderPage import HeaderPage
from public_method.Get_AllRoleAccountForTest import Get_AllRoleAccountForTest


class LeadershipAcademyProcessConfirmation_PannedToCompleted(unittest.TestCase):


    def setUp(self):
        #caseID
        self.caseID="LeadershipAcademyProcessConfirmation_PannedToCompleted"
        ...
        self.coachformname="Leadership Academy Process Confirmation" 
    ...
    def test_LeadershipAcademyProcessConfirmation_PannedToCompleted(self):
        ...
        Header=HeaderPage()
        LeadershipAcademyProcessConfirmationForm=LeadershipAcademyProcessConfirmation()
        ...
        for i in range(0,len(self.testLOBSITE_list)):
            ...
            if Flag==True:
                ...
                for n in range(0,len(site_list)):
                    ...
                    '''Check1:Enter form detail page with title Triad Coaching - Leadership Academy Process Confirmation'''
                    ...
                    #print LeadershipAcademyProcessConfirmationForm.samGoal_disabled()
                    assert LeadershipAcademyProcessConfirmationForm.samGoal_disabled()=='true'
                    for lineindex in range(2,5):
                        assert LeadershipAcademyProcessConfirmationForm.firstthreeinput_disabled(lineindex)=='true'
                    b=[3, 5, 7, 9, 11]
                    for lineindex2 in b:
                            #print LeadershipAcademyProcessConfirmationForm.comments_disabled(lineindex2)
                            assert LeadershipAcademyProcessConfirmationForm.comments_disabled(lineindex2)=='true'
                    ...
                    if lobname != "AOL":
                        BasicInfo.input_callrecordingnumber(CallRecordingNumber)
                    #input CURRENT SAM GOALS:
                    shorttext=self.Shorttextboxesprefix1+LeadershipAcademyProcessConfirmationForm.get_samGoalTitle()
                    LeadershipAcademyProcessConfirmationForm.input_samGoal(shorttext)
                    #input long text boxes
                    for lineindex in range(2,5):
                        firstthreelongtext=self.Longtextboxesprefix1+LeadershipAcademyProcessConfirmationForm.get_firstthreeinputtitle(lineindex)
                        LeadershipAcademyProcessConfirmationForm.input_firstthreeinput(lineindex, firstthreelongtext)
                    b=[3, 5, 7, 9, 11]
                    for lineindex2 in b:
                            commentstext=self.Longtextboxesprefix1+LeadershipAcademyProcessConfirmationForm.get_commentsTitle(lineindex2)
                            LeadershipAcademyProcessConfirmationForm.input_comments(lineindex2, commentstext)
                    ...
                    if lobname != "AOL":
                        ...
                        assert BasicInfo.callrecordingnumber_disabled()=='true'
                    print 'getsamgoalactual:',LeadershipAcademyProcessConfirmationForm.get_samGoal()
                    print 'getsamgoalexpected:',self.Shorttextboxesprefix1+LeadershipAcademyProcessConfirmationForm.get_samGoalTitle()
                    assert LeadershipAcademyProcessConfirmationForm.samGoal_disabled()=='true'
                    assert LeadershipAcademyProcessConfirmationForm.get_samGoal()==self.Shorttextboxesprefix1+LeadershipAcademyProcessConfirmationForm.get_samGoalTitle()
                        
                    for lineindex in range(2,5):
                        assert LeadershipAcademyProcessConfirmationForm.firstthreeinput_disabled(lineindex)=='true'
                        assert LeadershipAcademyProcessConfirmationForm.get_firstthreeinput(lineindex)==self.Longtextboxesprefix1+LeadershipAcademyProcessConfirmationForm.get_firstthreeinputtitle(lineindex)  
                    b=[3, 5, 7, 9, 11]
                    for lineindex2 in b:
                        assert LeadershipAcademyProcessConfirmationForm.comments_disabled(lineindex2)=='true'
                        assert LeadershipAcademyProcessConfirmationForm.get_connments(lineindex2)==self.Longtextboxesprefix1+LeadershipAcademyProcessConfirmationForm.get_commentsTitle(lineindex2)
