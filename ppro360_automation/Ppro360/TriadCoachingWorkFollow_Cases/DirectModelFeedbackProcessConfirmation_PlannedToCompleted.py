...
class DirectModelFeedbackProcessConfirmation_PlannedToCompleted(unittest.TestCase):


    def setUp(self):
        #Case ID
        self.caseID="DirectModelFeedbackProcessConfirmation_PlannedToCompleted"
    ...
    def test_DFM_PlannedToCanceled(self):
        ...
        for i in range(0,len(self.testLOBSITE_list)):
            ...
            if Flag==True:
                ...
                for n in range(0,len(site_list)):
                    ...
                    '''Check1:Enter form detail page with title Triad Coaching - Direct Model Feedback Process Confirmation'''
