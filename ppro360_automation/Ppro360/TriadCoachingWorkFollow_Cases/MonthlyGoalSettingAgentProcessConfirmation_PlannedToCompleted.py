...
from CoachingAndTriadCoaching_Pages.MonthlyGoalSettingAgentProcessConfirmation import MonthlyGoalSettingAgentProcessConfirmation
...
class MonthlyGoalSettingAgentProcessConfirmation_PlannedToCompleted(unittest.TestCase):


    def setUp(self):
        #Case ID
        self.caseID="MonthlyGoalSettingAgentProcessConfirmation_PlannedToCompleted"
        ...
        self.coachformname="Monthly Goal Setting - Agent Process Confirmation" 
    ...
    def test_MonthlyGoalSettingAgentProcessConfirmation_PlannedToCanceled(self):
        ...
        Header=HeaderPage()
        MonthlyGoalSettingAgentProcessConfirmationForm=MonthlyGoalSettingAgentProcessConfirmation()
        ...
        for i in range(0,len(self.testLOBSITE_list)):
            ...
            if Flag==True:
                ...
                for n in range(0,len(site_list)):
                    ...
                    assert MonthlyGoalSettingAgentProcessConfirmationForm.overallscore_disabled()=="true"
                    assert MonthlyGoalSettingAgentProcessConfirmationForm.get_overallscore()=="0"
                    ...
                    assert MonthlyGoalSettingAgentProcessConfirmationForm.overallscore_disabled()=="true"
                    assert MonthlyGoalSettingAgentProcessConfirmationForm.longcomments_disabled(10)=="true"
                    assert MonthlyGoalSettingAgentProcessConfirmationForm.longcomments_disabled(11)=="true"
                    a=1
                    while a<9:
                                a=a+1
                                assert MonthlyGoalSettingAgentProcessConfirmationForm.scoreinput_disabled(a)=="true"
                                assert MonthlyGoalSettingAgentProcessConfirmationForm.middlecomments_disabled(a)=="true"
                    ...
                    longcommentsBoxtitle=self.Longtextboxesprefix1+MonthlyGoalSettingAgentProcessConfirmationForm.get_longcommentsBoxtitle(10)
                    longcommentsBoxtitle2=self.Longtextboxesprefix1+MonthlyGoalSettingAgentProcessConfirmationForm.get_longcommentsBoxtitle(11)
                    ...
                    number3="3"
                    number4="2.33"
                    MonthlyGoalSettingAgentProcessConfirmationForm.input_longcomments(10,longcommentsBoxtitle)
                    MonthlyGoalSettingAgentProcessConfirmationForm.input_longcomments(11, longcommentsBoxtitle2)
                    MonthlyGoalSettingAgentProcessConfirmationForm.input_scoreinput(2,number2)
                    MonthlyGoalSettingAgentProcessConfirmationForm.input_scoreinput(4,number2)
                    MonthlyGoalSettingAgentProcessConfirmationForm.input_scoreinput(6,number3)
                    
                    b=1
                    while b<9:
                        b=b+1
                        middlecommentsBoxtitle=self.Shorttextboxesprefix1+MonthlyGoalSettingAgentProcessConfirmationForm.get_middlecommentsBoxtitle(b)
                        MonthlyGoalSettingAgentProcessConfirmationForm.input_middlecomments(b,middlecommentsBoxtitle)
                    ...
                    assert MonthlyGoalSettingAgentProcessConfirmationForm.get_longcomments(10)==longcommentsBoxtitle
                    assert MonthlyGoalSettingAgentProcessConfirmationForm.get_longcomments(11)==longcommentsBoxtitle2
                    assert MonthlyGoalSettingAgentProcessConfirmationForm.get_overallscore()==number4
                    assert MonthlyGoalSettingAgentProcessConfirmationForm.get_overallballstataus()==self.yellowball
                    assert MonthlyGoalSettingAgentProcessConfirmationForm.get_scoreinput(2)==number2
                    assert MonthlyGoalSettingAgentProcessConfirmationForm.get_scoreinput(4)==number2
                    assert MonthlyGoalSettingAgentProcessConfirmationForm.get_scoreinput(6)==number3
                    assert MonthlyGoalSettingAgentProcessConfirmationForm.get_scoreballstataus(2)==self.yellowball
                    assert MonthlyGoalSettingAgentProcessConfirmationForm.get_scoreballstataus(4)==self.yellowball
                    assert MonthlyGoalSettingAgentProcessConfirmationForm.get_scoreballstataus(6)==self.greenball
                     
                    c=1
                    while c<9:
                        c=c+1
                        middlecommentsBoxtitle=self.Shorttextboxesprefix1+MonthlyGoalSettingAgentProcessConfirmationForm.get_middlecommentsBoxtitle(c)
                        assert MonthlyGoalSettingAgentProcessConfirmationForm.get_middlecomments(c)==middlecommentsBoxtitle
