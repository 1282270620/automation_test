...
from CoachingAndTriadCoaching_Pages.MonthlyGoalSettingLeaderProcessConfirmation import MonthlyGoalSettingLeaderProcessConfirmation
...
class MonthlyGoalSettingLeaderProcessConfirmation_PlannedToCompleted(unittest.TestCase):


    def setUp(self):
        #Case ID
        self.caseID="MonthlyGoalSettingLeaderProcessConfirmation_PlannedToCompleted"
        ...
        self.coachformname="Monthly Goal Setting - Leader Process Confirmation" 
    ...
    def test_MonthlyGoalSettingLeaderProcessConfirmation_PlannedToCanceled(self):
        ...
        Header=HeaderPage()
        MonthlyGoalSettingLeaderProcessConfirmationForm=MonthlyGoalSettingLeaderProcessConfirmation()
        ...
        for i in range(0,len(self.testLOBSITE_list)):
            ...
            if Flag==True:
                ...
                for n in range(0,len(site_list)):
                    ...
                    assert MonthlyGoalSettingLeaderProcessConfirmationForm.overallscore_disabled()=="true"
                    assert MonthlyGoalSettingLeaderProcessConfirmationForm.get_overallscore()=="0"
                    ...
                    assert MonthlyGoalSettingLeaderProcessConfirmationForm.overallscore_disabled()=="true"
                    assert MonthlyGoalSettingLeaderProcessConfirmationForm.longcomments_disabled(8)=="true"
                    assert MonthlyGoalSettingLeaderProcessConfirmationForm.longcomments_disabled(9)=="true"
                    a=1
                    while a<7:
                                a=a+1
                                assert MonthlyGoalSettingLeaderProcessConfirmationForm.scoreinput_disabled(a)=="true"
                                assert MonthlyGoalSettingLeaderProcessConfirmationForm.middlecomments_disabled(a)=="true"
                    ...
                    longcommentsBoxtitle=self.Longtextboxesprefix1+MonthlyGoalSettingLeaderProcessConfirmationForm.get_longcommentsBoxtitle(8)
                    longcommentsBoxtitle2=self.Longtextboxesprefix1+MonthlyGoalSettingLeaderProcessConfirmationForm.get_longcommentsBoxtitle(9)
                    ...
                    number3="3"
                    number4="2.33"
                    MonthlyGoalSettingLeaderProcessConfirmationForm.input_longcomments(8,longcommentsBoxtitle)
                    MonthlyGoalSettingLeaderProcessConfirmationForm.input_longcomments(9, longcommentsBoxtitle2)
                    MonthlyGoalSettingLeaderProcessConfirmationForm.input_scoreinput(2,number2)
                    MonthlyGoalSettingLeaderProcessConfirmationForm.input_scoreinput(4,number2)
                    MonthlyGoalSettingLeaderProcessConfirmationForm.input_scoreinput(6,number3)
                    
                    b=1
                    while b<7:
                        b=b+1
                        middlecommentsBoxtitle=self.Shorttextboxesprefix1+MonthlyGoalSettingLeaderProcessConfirmationForm.get_middlecommentsBoxtitle(b)
                        MonthlyGoalSettingLeaderProcessConfirmationForm.input_middlecomments(b,middlecommentsBoxtitle)
                    ...
                    assert MonthlyGoalSettingLeaderProcessConfirmationForm.get_longcomments(8)==longcommentsBoxtitle
                    assert MonthlyGoalSettingLeaderProcessConfirmationForm.get_longcomments(9)==longcommentsBoxtitle2
                    assert MonthlyGoalSettingLeaderProcessConfirmationForm.get_overallscore()==number4
                    assert MonthlyGoalSettingLeaderProcessConfirmationForm.get_overallballstataus()==self.yellowball
                    assert MonthlyGoalSettingLeaderProcessConfirmationForm.get_scoreinput(2)==number2
                    assert MonthlyGoalSettingLeaderProcessConfirmationForm.get_scoreinput(4)==number2
                    assert MonthlyGoalSettingLeaderProcessConfirmationForm.get_scoreinput(6)==number3
                    assert MonthlyGoalSettingLeaderProcessConfirmationForm.get_scoreballstataus(2)==self.yellowball
                    assert MonthlyGoalSettingLeaderProcessConfirmationForm.get_scoreballstataus(4)==self.yellowball
                    assert MonthlyGoalSettingLeaderProcessConfirmationForm.get_scoreballstataus(6)==self.greenball
                     
                    c=1
                    while c<7:
                        c=c+1
                        middlecommentsBoxtitle=self.Shorttextboxesprefix1+MonthlyGoalSettingLeaderProcessConfirmationForm.get_middlecommentsBoxtitle(c)
                        assert MonthlyGoalSettingLeaderProcessConfirmationForm.get_middlecomments(c)==middlecommentsBoxtitle
