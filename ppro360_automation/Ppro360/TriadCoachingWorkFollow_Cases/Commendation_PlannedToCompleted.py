...
class Commendation_PlannedToCompleted(unittest.TestCase):


    def setUp(self):
        #Case ID
        self.caseID="Commendation_PlannedToCompleted"
        ...
        for i in range(0,len(self.testLOBSITE_list)):
            ...
            if Flag==True:
                ...
                for n in range(0,len(site_list)):
                    ...
                    Text_box="Performance pro test team to input content in text boxes ,alice_shu0823~!@#$%^&*();:'""?/\[]{},sabrina's@symbio.com."
                    ...
                    CommendationForm.input_commendation(Text_box)
                    ...
                    assert CommendationForm.get_commendation()==Text_box
