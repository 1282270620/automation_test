...
from CoachingAndTriadCoaching_Pages.GoalSettingPlanandNotesFormPage import GoalSettingPlanandNotesFormPage
from Tablet_pages.HeaderPage import HeaderPage
from public_method.Get_AllRoleAccountForTest import Get_AllRoleAccountForTest

class GoalSettingPlanandNotesForm_PlannedToCompleted(unittest.TestCase):


    def setUp(self):
        #Case ID
        self.caseID="GoalSettingPlanandNotesForm_PlannedToCompleted"
        ...
        self.coachformname="Goal Setting Plan and Notes Form" 
    ...
    def test_GoalSettingPlanandNotesForm_PlannedToCompleted(self):
        ...
        Header=HeaderPage()
        GoalSettingPlanandNotesForm=GoalSettingPlanandNotesFormPage()
        ...
        for i in range(0,len(self.testLOBSITE_list)):
            ...
            if Flag==True:
                ...
                for n in range(0,len(site_list)):
                    ...
                    userid=GoalSettingPlanandNotesForm.get_firstTL_HRID(1)
                    L.logout_tablet()
                    ...
                    assert GoalSettingPlanandNotesForm.ActionOneComments_disabled()=='true'
                    assert GoalSettingPlanandNotesForm.ActionTwoComments_disabled()=='true'
                    assert GoalSettingPlanandNotesForm.ActionThreeComments_disabled()=='true'
                    assert GoalSettingPlanandNotesForm.ActionFourComments_disabled()=='true'
                    assert GoalSettingPlanandNotesForm.ActionFiveComments_disabled()=='true'
                    assert GoalSettingPlanandNotesForm.ActionSixComments_disabled()=='true'
                    assert GoalSettingPlanandNotesForm.ActionSevenComments_disabled()=='true'
                    ...
                    GoalSettingPlanandNotesForm.input_ActionOneComments(self.Longtextboxesprefix1+GoalSettingPlanandNotesForm.get_TextboxTitle(1))
                    GoalSettingPlanandNotesForm.input_ActionTwoComments(self.Longtextboxesprefix1+GoalSettingPlanandNotesForm.get_TextboxTitle(3))
                    GoalSettingPlanandNotesForm.input_ActionThreeComments(self.Longtextboxesprefix1+GoalSettingPlanandNotesForm.get_TextboxTitle(5))
                    GoalSettingPlanandNotesForm.input_ActionFourComments(self.Longtextboxesprefix1+GoalSettingPlanandNotesForm.get_TextboxTitle(7))
                    GoalSettingPlanandNotesForm.input_ActionFiveComments(self.Longtextboxesprefix1+GoalSettingPlanandNotesForm.get_TextboxTitle(9))
                    GoalSettingPlanandNotesForm.input_ActionSixComments(self.Longtextboxesprefix1+GoalSettingPlanandNotesForm.get_TextboxTitle(11))
                    GoalSettingPlanandNotesForm.input_ActionSevenComments(self.Longtextboxesprefix1+GoalSettingPlanandNotesForm.get_TextboxTitle(13))
                    ...
                    assert GoalSettingPlanandNotesForm.get_ActionOneComments()==self.Longtextboxesprefix1+GoalSettingPlanandNotesForm.get_TextboxTitle(1)
                    assert GoalSettingPlanandNotesForm.get_ActionTwoComments()==self.Longtextboxesprefix1+GoalSettingPlanandNotesForm.get_TextboxTitle(3)
                    assert GoalSettingPlanandNotesForm.get_ActionThreeComments()==self.Longtextboxesprefix1+GoalSettingPlanandNotesForm.get_TextboxTitle(5)
                    assert GoalSettingPlanandNotesForm.get_ActionFourComments()==self.Longtextboxesprefix1+GoalSettingPlanandNotesForm.get_TextboxTitle(7)
                    assert GoalSettingPlanandNotesForm.get_ActionFiveComments()==self.Longtextboxesprefix1+GoalSettingPlanandNotesForm.get_TextboxTitle(9)
                    assert GoalSettingPlanandNotesForm.get_ActionSixComments()==self.Longtextboxesprefix1+GoalSettingPlanandNotesForm.get_TextboxTitle(11)
                    assert GoalSettingPlanandNotesForm.get_ActionSevenComments()==self.Longtextboxesprefix1+GoalSettingPlanandNotesForm.get_TextboxTitle(13)
