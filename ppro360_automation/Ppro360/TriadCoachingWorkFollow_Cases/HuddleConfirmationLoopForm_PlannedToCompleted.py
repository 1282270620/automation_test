...
from CoachingAndTriadCoaching_Pages.HuddleConfirmationLoopFormPage import HuddleConfirmationLoopFormPage
from Tablet_pages.HeaderPage import HeaderPage
from public_method.Get_AllRoleAccountForTest import Get_AllRoleAccountForTest

class HuddleConfirmationLoopFormPage_PlannedToCompleted(unittest.TestCase):


    def setUp(self):
        #Case ID
        self.caseID="HuddleConfirmationLoopFormPage_PlannedToCompleted"
        ...
        self.coachformname="Huddle Confirmation Loop Form" 
    ...
    def test_HuddleConfirmationLoopFormPage_PlannedToCompleted(self):
        ...
        Header=HeaderPage()
        HuddleConfirmationLoopForm=HuddleConfirmationLoopFormPage()
        ...
        for i in range(0,len(self.testLOBSITE_list)):
            ...
            if Flag==True:
                ...
                for n in range(0,len(site_list)):
                    ...
                    userid=HuddleConfirmationLoopForm.get_firstTL_HRID(1)
                    L.logout_tablet()
                    ...
                    assert HuddleConfirmationLoopForm.TheFirstFouComments_disabled(1,1)=='true'
                    assert HuddleConfirmationLoopForm.TheFirstFouComments_disabled(1,2)=='true'
                    assert HuddleConfirmationLoopForm.TheFirstFouComments_disabled(2,1)=='true'
                    assert HuddleConfirmationLoopForm.TheFirstFouComments_disabled(2,2)=='true'
                    assert HuddleConfirmationLoopForm.RemarksComments_disabled()=='true'
                    for i in range(4,7):
                        assert HuddleConfirmationLoopForm.BodyComments_disabled(i)=='true'
                    for j in range(8,10):
                        assert HuddleConfirmationLoopForm.LastComments_disabled(j)=='true'
                    assert HuddleConfirmationLoopForm.get_OverallScoreComments()=='0'
                    assert HuddleConfirmationLoopForm.get_OverallScoreColor()==self.RedButton
                    for k in range(4,7):
                        HuddleConfirmationLoopForm.ClickScoreButton(k, 1)
                        assert HuddleConfirmationLoopForm.get_ScoreButton(k, 1)==self.BodyButton_UnCheckedStatus
                    for m in range(4,7):
                        HuddleConfirmationLoopForm.ClickScoreButton(m, 2)
                        assert HuddleConfirmationLoopForm.get_ScoreButton(m, 2)==self.BodyButton_UnCheckedStatus    
                    assert HuddleConfirmationLoopForm.DateComments_disabled(1)=='true'
                    assert HuddleConfirmationLoopForm.DateComments_disabled(2)=='true'
                    ...
                    HuddleConfirmationLoopForm.input_TheFirstFour(1,1, self.Shorttextboxesprefix1)
                    HuddleConfirmationLoopForm.input_TheFirstFour(1,2, self.Shorttextboxesprefix1)
                    HuddleConfirmationLoopForm.input_TheFirstFour(2,1, self.Shorttextboxesprefix1)
                    HuddleConfirmationLoopForm.input_TheFirstFour(2,2, self.Shorttextboxesprefix1)
                    HuddleConfirmationLoopForm.click_DateButton(1)
                    HuddleConfirmationLoopForm.click_Date(1)
                    HuddleConfirmationLoopForm.click_DateButton(2)
                    HuddleConfirmationLoopForm.click_Date(2)
                    HuddleConfirmationLoopForm.input_RemarksComments(self.Shorttextboxesprefix1)
                    for i1 in range(4,7):
                        HuddleConfirmationLoopForm.input_BodyComments(i1, self.Shorttextboxesprefix1)
                    HuddleConfirmationLoopForm.ClickScoreButton(4, 1)
                    HuddleConfirmationLoopForm.ClickScoreButton(5, 1)
                    HuddleConfirmationLoopForm.ClickScoreButton(6, 2)
                    HuddleConfirmationLoopForm.input_LastComments(8, self.Longtextboxesprefix1)
                    HuddleConfirmationLoopForm.input_LastComments(9, self.Longtextboxesprefix1)
                    ...
                    assert HuddleConfirmationLoopForm.get_TheFirstFouComments(1, 1)==self.Shorttextboxesprefix1
                    assert HuddleConfirmationLoopForm.get_TheFirstFouComments(1, 2)==self.Shorttextboxesprefix1
                    assert HuddleConfirmationLoopForm.get_TheFirstFouComments(2, 1)==self.Shorttextboxesprefix1
                    assert HuddleConfirmationLoopForm.get_TheFirstFouComments(2, 2)==self.Shorttextboxesprefix1
                    assert HuddleConfirmationLoopForm.get_RemarksComments()==self.Shorttextboxesprefix1
                    assert HuddleConfirmationLoopForm.get_BodyComments(4)==self.Shorttextboxesprefix1
                    assert HuddleConfirmationLoopForm.get_BodyComments(5)==self.Shorttextboxesprefix1
                    assert HuddleConfirmationLoopForm.get_BodyComments(6)==self.Shorttextboxesprefix1
                    assert HuddleConfirmationLoopForm.get_ScoreButton(4, 1)==self.BodyButton_CheckedStatus
                    assert HuddleConfirmationLoopForm.get_ScoreButton(5, 1)==self.BodyButton_CheckedStatus
                    assert HuddleConfirmationLoopForm.get_ScoreButton(6, 1)==self.BodyButton_UnCheckedStatus
                    assert HuddleConfirmationLoopForm.get_ScoreButton(4, 2)==self.BodyButton_UnCheckedStatus
                    assert HuddleConfirmationLoopForm.get_ScoreButton(5, 2)==self.BodyButton_UnCheckedStatus
                    assert HuddleConfirmationLoopForm.get_ScoreButton(6, 2)==self.BodyButton_CheckedStatus
                    assert HuddleConfirmationLoopForm.get_OverallScoreComments()=='2'
                    assert HuddleConfirmationLoopForm.get_OverallScoreColor()==self.YellowButton
                    assert HuddleConfirmationLoopForm.get_LastComments(8)==self.Longtextboxesprefix1
                    assert HuddleConfirmationLoopForm.get_LastComments(9)==self.Longtextboxesprefix1
