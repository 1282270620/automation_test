...
from CoachingAndTriadCoaching_Pages.CareCommitmentFormPage import CareCommitmentFormPage
from Tablet_pages.HeaderPage import HeaderPage
from public_method.Get_AllRoleAccountForTest import Get_AllRoleAccountForTest

class CareCommitment_PlannedToCompleted(unittest.TestCase):


    def setUp(self):
        #Case ID
        self.caseID="CareCommitment_PlannedToCompleted"
        ...
        self.coachformname="Care Commitment" 
    ...
    def test_CareCommitment_PlannedToCompleted(self):
        ...
        Header=HeaderPage()
        CareCommitmentFormPageForm=CareCommitmentFormPage()
        ...
        for i in range(0,len(self.testLOBSITE_list)):
            ...
            if Flag==True:
                ...
                for n in range(0,len(site_list)):
                    ...
                    userid=CareCommitmentFormPageForm.get_firstTL_HRID(1)
                    L.logout_tablet()
                    ...
                    assert CareCommitmentFormPageForm.FirstLongComments_disabled()=='true'
                    assert CareCommitmentFormPageForm.SecondLongComments_disabled()=='true'
                    assert CareCommitmentFormPageForm.LastLongComments_disabled()=='true'
                    i1=2
                    while i1<10:
                                i1=i1+1
                                assert CareCommitmentFormPageForm.BodyShortComments_disabled(i1,1,1)=='true'
                    i2=2
                    while i2<10:
                                i2=i2+1
                                assert CareCommitmentFormPageForm.BodyShortComments_disabled(i2,1,2)=='true'
                    i3=2
                    while i3<10:
                                i3=i3+1
                                assert CareCommitmentFormPageForm.BodyShortComments_disabled(i3,2,1)=='true'
                    i4=2
                    while i4<10:
                                i4=i4+1
                                assert CareCommitmentFormPageForm.BodyShortComments_disabled(i4,2,2)=='true'
                    ...
                    CareCommitmentFormPageForm.input_FirstLongComments(self.Longtextboxesprefix1+CareCommitmentFormPageForm.get_LongTextboxTitle_loc(2))
                    CareCommitmentFormPageForm.input_SecondLongComments(self.Longtextboxesprefix1+CareCommitmentFormPageForm.get_LongTextboxTitle_loc(11))
                    CareCommitmentFormPageForm.input_LastLongComments(self.Longtextboxesprefix1+CareCommitmentFormPageForm.get_LongTextboxTitle_loc(12))
                    j1=2
                    while j1<10:
                                j1=j1+1
                                CareCommitmentFormPageForm.input_BodyShortComments(j1, 1, 1, (self.Shorttextboxesprefix1+CareCommitmentFormPageForm.get_ShortTextboxTitle_loc(j1, 1, 1)))
                    j2=2
                    while j2<10:
                                j2=j2+1
                                CareCommitmentFormPageForm.input_BodyShortComments(j2, 1, 2, (self.Shorttextboxesprefix1+CareCommitmentFormPageForm.get_ShortTextboxTitle_loc(j2, 1, 2)))
                    j3=2
                    while j3<10:
                                j3=j3+1
                                CareCommitmentFormPageForm.input_BodyShortComments(j3, 2, 1, (self.Shorttextboxesprefix1+CareCommitmentFormPageForm.get_ShortTextboxTitle_loc(j3, 2, 1)))
                    j4=2
                    while j4<10:
                                j4=j4+1
                                CareCommitmentFormPageForm.input_BodyShortComments(j4, 2, 2, (self.Shorttextboxesprefix1+CareCommitmentFormPageForm.get_ShortTextboxTitle_loc(j4, 2, 2)))
                    ...
                    assert CareCommitmentFormPageForm.getFirstLongComments_loc()==self.Longtextboxesprefix1+CareCommitmentFormPageForm.get_LongTextboxTitle_loc(2)
                    assert CareCommitmentFormPageForm.getSecondLongComments_loc()==self.Longtextboxesprefix1+CareCommitmentFormPageForm.get_LongTextboxTitle_loc(11)
                    assert CareCommitmentFormPageForm.getLastLongComments_loc()==self.Longtextboxesprefix1+CareCommitmentFormPageForm.get_LongTextboxTitle_loc(12)
                    k1=2
                    while k1<10:
                                k1=k1+1
                                assert CareCommitmentFormPageForm.getBodyShortComments_loc(k1, 1, 1)==self.Shorttextboxesprefix1+CareCommitmentFormPageForm.get_ShortTextboxTitle_loc(k1,1,1)
                    k2=2
                    while k2<10:
                                k2=k2+1
                                assert CareCommitmentFormPageForm.getBodyShortComments_loc(k2, 1, 2)==self.Shorttextboxesprefix1+CareCommitmentFormPageForm.get_ShortTextboxTitle_loc(k2,1,2)
                    k3=2
                    while k3<10:
                                k3=k3+1
                                assert CareCommitmentFormPageForm.getBodyShortComments_loc(k3, 2, 1)==self.Shorttextboxesprefix1+CareCommitmentFormPageForm.get_ShortTextboxTitle_loc(k3,2,1)
                    k4=2
                    while k4<10:
                                k4=k4+1
                                assert CareCommitmentFormPageForm.getBodyShortComments_loc(k4, 2, 2)==self.Shorttextboxesprefix1+CareCommitmentFormPageForm.get_ShortTextboxTitle_loc(k4,2,2)
