...
from CoachingAndTriadCoaching_Pages.AccessObservation import AccessObservation
...
class AccessObservation_PlannedToCompleted(unittest.TestCase):


    def setUp(self):
        #Case ID
        self.caseID="AccessObservation_PlannedToCompleted"
        ...
        self.coachformname="Access Observation" 
        ...
        #radiobutton status
        self.RadioButton_CheckedStatus='fa fa-check-circle checked'
        self.RadioButton_UnCheckedStatus='fa fa-check-circle'
    ...
    def test_AccessObservation_PlannedToCompleted(self):
        ...
        Header=HeaderPage()
        AccessObservationForm=AccessObservation()
        ...
        for i in range(0,len(self.testLOBSITE_list)):
            ...
            if Flag==True:
                ...
                for n in range(0,len(site_list)):
                    ...
                    for lineindex in range (1,15):
                        AccessObservationForm.click_RadioButton(lineindex, 1)
                        assert AccessObservationForm.get_RadioButtonStatus(lineindex,1)==self.RadioButton_UnCheckedStatus
                        AccessObservationForm.click_RadioButton(lineindex, 2)
                        assert AccessObservationForm.get_RadioButtonStatus(lineindex,2)==self.RadioButton_UnCheckedStatus
                        AccessObservationForm.click_RadioButton(lineindex,3)
                        assert AccessObservationForm.get_RadioButtonStatus(lineindex,3)==self.RadioButton_CheckedStatus
                    assert AccessObservationForm.associateCommitment_disabled()=='true'
                    ...
                    Text_box=self.Longtextboxesprefix1+AccessObservationForm.get_associateCommitmentTitle()
                    ...
                    AccessObservationForm.input_associateCommitment(Text_box)
                    ...
                    assert AccessObservationForm.get_associateCommitment()==self.Longtextboxesprefix1+AccessObservationForm.get_associateCommitmentTitle()
                    for lineindex in range (1,15):
                        AccessObservationForm.click_RadioButton(lineindex,1)
                        assert AccessObservationForm.get_RadioButtonStatus(lineindex,1)==self.RadioButton_CheckedStatus
                        AccessObservationForm.click_RadioButton(lineindex,2)
                        print AccessObservationForm.get_RadioButtonStatus(lineindex,2)
                        print self.RadioButton_UnCheckedStatus
                        assert AccessObservationForm.get_RadioButtonStatus(lineindex,2)==self.RadioButton_UnCheckedStatus
                        AccessObservationForm.click_RadioButton(lineindex,3)
                        assert AccessObservationForm.get_RadioButtonStatus(lineindex,3)==self.RadioButton_UnCheckedStatus
                    assert AccessObservationForm.associateCommitment_disabled()=='true'
