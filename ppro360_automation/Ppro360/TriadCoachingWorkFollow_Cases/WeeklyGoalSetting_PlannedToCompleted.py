...
from CoachingAndTriadCoaching_Pages.WeeklyGoalSetting import WeeklyGoalSetting
...
class WeeklyGoalSetting_PlannedToCompleted(unittest.TestCase):


    def setUp(self):
        #Case ID
        self.caseID="WeeklyGoalSetting_PlannedToCompleted"
        ...
        self.coachformname="Weekly Goal Setting" 
    ...
    def test_WeeklyGoalSetting_PlannedToCanceled(self):
        ...
        Header=HeaderPage()
        WeeklyGoalSettingForm=WeeklyGoalSetting()
        ...
        for i in range(0,len(self.testLOBSITE_list)):
            ...
            if Flag==True:
                ...
                for n in range(0,len(site_list)):
                    ...
                    assert WeeklyGoalSettingForm.actionplan_disabled()=="true"
                    assert WeeklyGoalSettingForm.agentcommitment_disabled()=="true"
                    assert WeeklyGoalSettingForm.TLcommitment_disabled()=="true"
                    a=0
                    while a<7:
                                a=a+1
                                b=1
                                while b<5:
                                    b=b+1
                                    assert WeeklyGoalSettingForm.PerformanceReview_disabled(a,b)=="true"
                    ...
                    actionplanBoxTitle=self.Longtextboxesprefix1+WeeklyGoalSettingForm.get_actionplanBoxTitle()
                    agentcommitmentBoxTitle=self.Longtextboxesprefix1+WeeklyGoalSettingForm.get_agentcommitmentBoxTitle()
                    TLcommitmentBoxTitle=self.Longtextboxesprefix1+WeeklyGoalSettingForm.get_TLcommitmentBoxTitle()
                    ReasonBox=self.Longtextboxesprefix1
                    ReasonBox2=self.Longtextboxesprefix1
                    weeklygoal="189"
                    Improvement="976"
                    Personalgoal="76"
                    weeklygoal2="85.00%"
                    ...
                    if lobname != "AOL":
                        BasicInfo.input_callrecordingnumber(CallRecordingNumber)
                    WeeklyGoalSettingForm.input_actionplan(actionplanBoxTitle)
                    WeeklyGoalSettingForm.input_agentcommitment(agentcommitmentBoxTitle)
                    WeeklyGoalSettingForm.input_TLcommitment(TLcommitmentBoxTitle)
                    WeeklyGoalSettingForm.input_PerformanceReview(1, 2,weeklygoal)
                    WeeklyGoalSettingForm.input_PerformanceReview(1, 3,Improvement)
                    WeeklyGoalSettingForm.input_PerformanceReview(1, 4,ReasonBox)
                    WeeklyGoalSettingForm.input_PerformanceReview(1, 5,Personalgoal)
                    WeeklyGoalSettingForm.input_PerformanceReview(7, 2,weeklygoal2)
                    WeeklyGoalSettingForm.input_PerformanceReview(7, 3,Improvement2)
                    WeeklyGoalSettingForm.input_PerformanceReview(7, 4,ReasonBox2)
                    WeeklyGoalSettingForm.input_PerformanceReview(7, 5,Personalgoal2)
                    ...
                    assert WeeklyGoalSettingForm.get_actionplan()==actionplanBoxTitle
                    assert WeeklyGoalSettingForm.get_agentcommitment()==agentcommitmentBoxTitle
                    assert WeeklyGoalSettingForm.get_TLcommitment()==TLcommitmentBoxTitle
                    assert WeeklyGoalSettingForm.get_PerformanceReview(1,2)==weeklygoal
                    assert WeeklyGoalSettingForm.get_PerformanceReview(1,3)==Improvement
                    assert WeeklyGoalSettingForm.get_PerformanceReview(1,4)==ReasonBox
                    assert WeeklyGoalSettingForm.get_PerformanceReview(1,5)==Personalgoal
                    assert WeeklyGoalSettingForm.get_PerformanceReview(7,2)==weeklygoal2
                    assert WeeklyGoalSettingForm.get_PerformanceReview(7,3)==Improvement2
                    assert WeeklyGoalSettingForm.get_PerformanceReview(7,4)==ReasonBox2
                    assert WeeklyGoalSettingForm.get_PerformanceReview(7,5)==Personalgoal2
