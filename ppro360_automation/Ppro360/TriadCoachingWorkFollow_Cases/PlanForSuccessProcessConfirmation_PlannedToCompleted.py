...
from CoachingAndTriadCoaching_Pages.PlanForSuccessProcessConfirmation import PlanForSuccessProcessConfirmation
...
class PlanForSuccessProcessConfirmation_PlannedToCompleted(unittest.TestCase):


    def setUp(self):
        #Case ID
        self.caseID="PlanForSuccessProcessConfirmation_PlannedToCompleted"
        ...
        self.coachformname="Plan For Success Process Confirmation" 
    ...
    def test_PlanForSuccessProcessConfirmation_PlannedToCanceled(self):
        ...
        Header=HeaderPage()
        PlanForSuccessProcessConfirmationForm=PlanForSuccessProcessConfirmation()
        ...
        for i in range(0,len(self.testLOBSITE_list)):
            ...
            if Flag==True:
                ...
                for n in range(0,len(site_list)):
                    ...
                    assert PlanForSuccessProcessConfirmationForm.overallscore_disabled()=="true"
                    assert PlanForSuccessProcessConfirmationForm.get_overallscore()=="0"
                    ...
                    assert PlanForSuccessProcessConfirmationForm.comments_disabled(14)=="true"
                    assert PlanForSuccessProcessConfirmationForm.overallscore_disabled()=="true"
                    a=0
                    while a<12:
                                a=a+2
                                assert PlanForSuccessProcessConfirmationForm.scoreinput_disabled(a)=="true"
                    a1=1
                    while a1<13:
                                a1=a1+2    
                                assert PlanForSuccessProcessConfirmationForm.comments_disabled(a1)=="true"
                    ...
                    commentsBoxtitle=self.Longtextboxesprefix1+PlanForSuccessProcessConfirmationForm.get_commentsBoxtitle(14)
                    ...
                    number3="3"
                    number4="2.33"
                    PlanForSuccessProcessConfirmationForm.input_comments(14,commentsBoxtitle)
                    PlanForSuccessProcessConfirmationForm.input_scoreinput(2,number2)
                    PlanForSuccessProcessConfirmationForm.input_scoreinput(6,number2)
                    PlanForSuccessProcessConfirmationForm.input_scoreinput(10,number3)
                    b=1
                    while b<13:
                        b=b+2
                        commentsBoxtitle2=self.Longtextboxesprefix1+PlanForSuccessProcessConfirmationForm.get_commentsBoxtitle(b)
                        PlanForSuccessProcessConfirmationForm.input_comments(b,commentsBoxtitle2)
                    ...
                    assert PlanForSuccessProcessConfirmationForm.get_comments(14)==commentsBoxtitle
                    assert PlanForSuccessProcessConfirmationForm.get_overallscore()==number4
                    assert PlanForSuccessProcessConfirmationForm.get_overallballstataus()==self.yellowball
                    assert PlanForSuccessProcessConfirmationForm.get_scoreinput(2)==number2
                    assert PlanForSuccessProcessConfirmationForm.get_scoreinput(6)==number2
                    assert PlanForSuccessProcessConfirmationForm.get_scoreinput(10)==number3
                    assert PlanForSuccessProcessConfirmationForm.get_scoreballstataus(2)==self.yellowball
                    assert PlanForSuccessProcessConfirmationForm.get_scoreballstataus(6)==self.yellowball
                    assert PlanForSuccessProcessConfirmationForm.get_scoreballstataus(10)==self.greenball
                    c=1
                    while c<13:
                        c=c+2
                        commentsBoxtitle2=self.Longtextboxesprefix1+PlanForSuccessProcessConfirmationForm.get_commentsBoxtitle(c)
                        assert PlanForSuccessProcessConfirmationForm.get_comments(c)==commentsBoxtitle2
