...
from CoachingAndTriadCoaching_Pages.OntheFlyProcessConfirmation import OntheFlyProcessConfirmation
...
class OntheFlyProcessConfirmation_PlannedToCompleted(unittest.TestCase):


    def setUp(self):
        #Case ID
        self.caseID="OntheFlyProcessConfirmation_PlannedToCompleted"
        ...
        self.coachformname="On the Fly Process Confirmation" 
    ...
    def test_OntheFlyProcessConfirmation_PlannedToCanceled(self):
        ...
        Header=HeaderPage()
        OntheFlyProcessConfirmationForm=OntheFlyProcessConfirmation()
        ...
        for i in range(0,len(self.testLOBSITE_list)):
            ...
            if Flag==True:
                ...
                for n in range(0,len(site_list)):
                    ...
                    assert OntheFlyProcessConfirmationForm.overallscore_disabled()=="true"
                    assert OntheFlyProcessConfirmationForm.get_overallscore()=="0"
                    ...
                    while a<14:
                                a=a+2
                                assert OntheFlyProcessConfirmationForm.scoreinput_disabled(a)=="true"
                    a1=1
                    while a1<15:
                                a1=a1+2    
                                assert OntheFlyProcessConfirmationForm.comments_disabled(a1)=="true"
                    ...
                    number3="3"
                    number4="2.33"
                    OntheFlyProcessConfirmationForm.input_scoreinput(2,number2)
                    OntheFlyProcessConfirmationForm.input_scoreinput(6,number2)
                    OntheFlyProcessConfirmationForm.input_scoreinput(10,number3)
                    b=1
                    while b<15:
                        b=b+2
                        commentsBoxtitle2=self.Longtextboxesprefix1+OntheFlyProcessConfirmationForm.get_commentsBoxtitle(b)
                        OntheFlyProcessConfirmationForm.input_comments(b,commentsBoxtitle2)
                    ...
                    assert OntheFlyProcessConfirmationForm.get_overallscore()==number4
                    assert OntheFlyProcessConfirmationForm.get_overallballstataus()==self.yellowball
                    assert OntheFlyProcessConfirmationForm.get_scoreinput(2)==number2
                    assert OntheFlyProcessConfirmationForm.get_scoreinput(6)==number2
                    assert OntheFlyProcessConfirmationForm.get_scoreinput(10)==number3
                    assert OntheFlyProcessConfirmationForm.get_scoreballstataus(2)==self.yellowball
                    assert OntheFlyProcessConfirmationForm.get_scoreballstataus(6)==self.yellowball
                    assert OntheFlyProcessConfirmationForm.get_scoreballstataus(10)==self.greenball
                     
                    c=1
                    while c<15:
                        c=c+2
                        commentsBoxtitle2=self.Longtextboxesprefix1+OntheFlyProcessConfirmationForm.get_commentsBoxtitle(c)
                        assert OntheFlyProcessConfirmationForm.get_comments(c)==commentsBoxtitle2
