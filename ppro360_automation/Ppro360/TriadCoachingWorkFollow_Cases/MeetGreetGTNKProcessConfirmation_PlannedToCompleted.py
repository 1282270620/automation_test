...
from CoachingAndTriadCoaching_Pages.MeetGreetGTNKProcessConfirmation import MeetGreetGTNKProcessConfirmation
...
class MeetGreetGTNKProcessConfirmation_PlannedToCompleted(unittest.TestCase):


    def setUp(self):
        #Case ID
        self.caseID="MeetGreetGTNKProcessConfirmation_PlannedToCompleted"
