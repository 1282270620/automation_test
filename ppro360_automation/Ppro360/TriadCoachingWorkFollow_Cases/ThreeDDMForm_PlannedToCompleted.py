...
from CoachingAndTriadCoaching_Pages.ThreeDDMFormPage import ThreeDDMFormPage
from Tablet_pages.HeaderPage import HeaderPage
from public_method.Get_AllRoleAccountForTest import Get_AllRoleAccountForTest

class ThreeDDMForm_PlannedToCompleted(unittest.TestCase):


    def setUp(self):
        #Case ID
        self.caseID="ThreeDDMForm_PlannedToCompleted"
        ...
        for i in range(0,len(self.testLOBSITE_list)):
            ...
            if Flag==True:
                ...
                for n in range(0,len(site_list)):
                    ...
                    userid=ThreeDDMForm.get_firstTL_HRID(1)
                    L.logout_tablet()
                    ...
                    assert ThreeDDMForm.TextKpiComments_disabled(1, 1)=='true'
                    assert ThreeDDMForm.TextKpiComments_disabled(1, 2)=='true'
                    assert ThreeDDMForm.TextKpiComments_disabled(2, 1)=='true'
                    assert ThreeDDMForm.TextKpiComments_disabled(2, 2)=='true'
                    assert ThreeDDMForm.RemarkComments_disabled()=='true'
                    for i in range(4,7):
                        assert ThreeDDMForm.BodyComments_disabled(i)=='true'
                    ThreeDDMForm.Click_BodyButton(4, 1)
                    assert ThreeDDMForm.get_BodyButtonStatus(4, 1)==self.BodyButton_UnCheckedStatus
                    ThreeDDMForm.Click_BodyButton(5, 1)
                    assert ThreeDDMForm.get_BodyButtonStatus(5, 1)==self.BodyButton_UnCheckedStatus
                    ThreeDDMForm.Click_BodyButton(6, 1)
                    assert ThreeDDMForm.get_BodyButtonStatus(5, 1)==self.BodyButton_UnCheckedStatus
                    assert ThreeDDMForm.get_BodyButtonStatus(4, 2)==self.BodyButton_UnCheckedStatus
                    assert ThreeDDMForm.get_BodyButtonStatus(5, 2)==self.BodyButton_UnCheckedStatus
                    assert ThreeDDMForm.get_BodyButtonStatus(6, 2)==self.BodyButton_UnCheckedStatus
                    assert ThreeDDMForm.get_OverScoreComments()=='0'
                    assert ThreeDDMForm.get_OverScoreStatus()==self.RedBall
                    assert ThreeDDMForm.LastComments_disabled(8)=='true'
                    assert ThreeDDMForm.LastComments_disabled(9)=='true'
                    ...
                    ThreeDDMForm.input_TextKpiComments(1, 1, self.Shorttextboxesprefix1)
                    ThreeDDMForm.input_TextKpiComments(1, 2, self.Shorttextboxesprefix1)
                    ThreeDDMForm.input_TextKpiComments(2, 1, self.Shorttextboxesprefix1)
                    ThreeDDMForm.input_TextKpiComments(2, 2, self.Shorttextboxesprefix1)
                    ThreeDDMForm.input_RemarkComments(self.Shorttextboxesprefix1)
                    ThreeDDMForm.click_DateButton(1)
                    ThreeDDMForm.click_Date(1)
                    ThreeDDMForm.click_DateButton(2)
                    ThreeDDMForm.click_Date(2)
                    for j in range(4,7):
                        ThreeDDMForm.input_BodyComments(j, self.Shorttextboxesprefix1)
                    ThreeDDMForm.Click_BodyButton(4, 1)
                    ThreeDDMForm.Click_BodyButton(5, 1)
                    ThreeDDMForm.Click_BodyButton(6, 2)
                    ThreeDDMForm.input_LastComments(8, self.Longtextboxesprefix1)
                    ThreeDDMForm.input_LastComments(9, self.Longtextboxesprefix1)
                    ...
                    assert ThreeDDMForm.get_TextKpiComments(1, 1)==self.Shorttextboxesprefix1
                    assert ThreeDDMForm.get_TextKpiComments(1, 2)==self.Shorttextboxesprefix1
                    assert ThreeDDMForm.get_TextKpiComments(2, 1)==self.Shorttextboxesprefix1
                    assert ThreeDDMForm.get_TextKpiComments(2, 2)==self.Shorttextboxesprefix1
                    assert ThreeDDMForm.get_RemarkComments()==self.Shorttextboxesprefix1
                    for k in range(4,7):
                        assert ThreeDDMForm.get_BodyComments(k)==self.Shorttextboxesprefix1
                    assert ThreeDDMForm.get_BodyButtonStatus(4, 1)==self.BodyButton_CheckedStatus
                    assert ThreeDDMForm.get_BodyButtonStatus(5, 1)==self.BodyButton_CheckedStatus
                    assert ThreeDDMForm.get_BodyButtonStatus(6, 1)==self.BodyButton_UnCheckedStatus
                    assert ThreeDDMForm.get_BodyButtonStatus(4, 2)==self.BodyButton_UnCheckedStatus
                    assert ThreeDDMForm.get_BodyButtonStatus(5, 2)==self.BodyButton_UnCheckedStatus
                    assert ThreeDDMForm.get_BodyButtonStatus(6, 2)==self.BodyButton_CheckedStatus
                    assert ThreeDDMForm.get_OverScoreComments()=='2'
                    assert ThreeDDMForm.get_OverScoreStatus()==self.YellowBall
                    assert ThreeDDMForm.get_LastComments(8)==self.Longtextboxesprefix1
                    assert ThreeDDMForm.get_LastComments(9)==self.Longtextboxesprefix1
