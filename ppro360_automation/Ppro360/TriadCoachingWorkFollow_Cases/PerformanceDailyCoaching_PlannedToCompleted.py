...
from CoachingAndTriadCoaching_Pages.PerformanceDailyCoachingPage import PerformanceDailyCoachingPage
from Tablet_pages.HeaderPage import HeaderPage
from public_method.Get_AllRoleAccountForTest import Get_AllRoleAccountForTest

class PerformanceDailyCoaching_PlannedToCompleted(unittest.TestCase):


    def setUp(self):
        #Case ID
        self.caseID="PerformanceDailyCoaching_PlannedToCompleted"
        ...
        self.coachformname="Performance Daily Coaching" 
    ...
    def test_PerformanceDailyCoaching_PlannedToCompleted(self):
        ...
        Header=HeaderPage()
        PerformanceDailyCoachingForm=PerformanceDailyCoachingPage()
        ...
        for i in range(0,len(self.testLOBSITE_list)):
            ...
            if Flag==True:
                ...
                for n in range(0,len(site_list)):
                    ...
                    userid=PerformanceDailyCoachingForm.get_firstTL_HRID(1)
                    L.logout_tablet()
                    ...
                    '''Check1:Enter form detail page with title Triad Coaching - Performance Daily Coaching'''
                    ...
                    for i in range(2,10):
                        if i==5 or i==7:
                            for i1 in range(1,5):
                                assert PerformanceDailyCoachingForm.Long2Comments_disabled(i,i1)=="true"
                        else:
                            assert PerformanceDailyCoachingForm.Long1Comments_disabled(i)=="true"
                    ...
                    '''
                    PerformanceDailyCoachingForm.click_LastKpi()
                    #BasicInfo.click_anyKPIstatusofCheckBox(2)#Uncheck the first KPI.
                    #PerformanceDailyCoachingForm.click_FirstKpi()#Uncheck the first KPI.
                    for j in range(2,10):
                        if j==5 or j==7:
                            for j1 in range(1,5):
                                PerformanceDailyCoachingForm.input_Long2Comments(j,j1, (self.Longtextboxesprefix1+PerformanceDailyCoachingForm.get_TitleComments(j)))
                        else:
                            PerformanceDailyCoachingForm.input_Long1Comments(j, (self.Longtextboxesprefix1+PerformanceDailyCoachingForm.get_TitleComments(j)))
                    ...
                    for index in range(2,KPInumber):
                        ...
                        '''
                    assert PerformanceDailyCoachingForm.get_LastKpiStatus()==self.CheckBox_CheckedStatus
                    ...
                    for k in range(2,10):
                        if k==5 or k==7:
                            for k1 in range(1,5):
                                assert PerformanceDailyCoachingForm.get_Long2Comments(k, k1)==self.Longtextboxesprefix1+PerformanceDailyCoachingForm.get_TitleComments(k)
                        else:
                            assert PerformanceDailyCoachingForm.get_Long1Comments(k)==self.Longtextboxesprefix1+PerformanceDailyCoachingForm.get_TitleComments(k)
