...
from CoachingAndTriadCoaching_Pages.HotLapProcessConfirmation import HotLapProcessConfirmation
...
class HotLapProcessConfirmation_PlannedToCompleted(unittest.TestCase):


    def setUp(self):
        #Case ID
        self.caseID="HotLapProcessConfirmation_PlannedToCompleted"
        ...
        self.coachformname="Hot Lap Process Confirmation" 
    ...
    def test_HotLapProcessConfirmation_PlannedToCanceled(self):
        ...
        Header=HeaderPage()
        HotLapProcessConfirmationForm=HotLapProcessConfirmation()
        ...
        for i in range(0,len(self.testLOBSITE_list)):
            ...
            if Flag==True:
                ...
                for n in range(0,len(site_list)):
                    ...
                    assert HotLapProcessConfirmationForm.overallscore_disabled()=="true"
                    assert HotLapProcessConfirmationForm.get_overallscore()=="0"
                    ...
                    while a<12:
                                a=a+2
                                assert HotLapProcessConfirmationForm.scoreinput_disabled(a)=="true"
                    a1=1
                    while a1<13:
                                a1=a1+2    
                                assert HotLapProcessConfirmationForm.comments_disabled(a1)=="true"
                    ...
                    number3="3"
                    number4="2.33"
                    HotLapProcessConfirmationForm.input_scoreinput(2,number2)
                    HotLapProcessConfirmationForm.input_scoreinput(6,number2)
                    HotLapProcessConfirmationForm.input_scoreinput(10,number3)
                    b=1
                    while b<13:
                        b=b+2
                        commentsBoxtitle2=self.Longtextboxesprefix1+HotLapProcessConfirmationForm.get_commentsBoxtitle(b)
                        HotLapProcessConfirmationForm.input_comments(b,commentsBoxtitle2)
                    ...
                    assert HotLapProcessConfirmationForm.get_overallscore()==number4
                    assert HotLapProcessConfirmationForm.get_overallballstataus()==self.yellowball
                    assert HotLapProcessConfirmationForm.get_scoreinput(2)==number2
                    assert HotLapProcessConfirmationForm.get_scoreinput(6)==number2
                    assert HotLapProcessConfirmationForm.get_scoreinput(10)==number3
                    assert HotLapProcessConfirmationForm.get_scoreballstataus(2)==self.yellowball
                    assert HotLapProcessConfirmationForm.get_scoreballstataus(6)==self.yellowball
                    assert HotLapProcessConfirmationForm.get_scoreballstataus(10)==self.greenball
                     
                    c=1
                    while c<13:
                        c=c+2
                        commentsBoxtitle2=self.Longtextboxesprefix1+HotLapProcessConfirmationForm.get_commentsBoxtitle(c)
                        assert HotLapProcessConfirmationForm.get_comments(c)==commentsBoxtitle2
