...
from CoachingAndTriadCoaching_Pages.SkillTransfer import SkillTransfer
...
class SkillTransfer_PlannedToCompleted(unittest.TestCase):


    def setUp(self):
        #Case ID
        self.caseID="SkillTransfer_PlannedToCompleted"
        ...
        self.coachformname="Skill Transfer" 
    ...
    def test_SkillTransfer_PlannedToCanceled(self):
        ...
        Header=HeaderPage()
        SkillTransferForm=SkillTransfer()
        ...
        for i in range(0,len(self.testLOBSITE_list)):
            ...
            if Flag==True:
                ...
                for n in range(0,len(site_list)):
                    ...
                    assert SkillTransferForm.focus_disabled()=="true"
                    assert SkillTransferForm.importance_disabled()=="true"
                    assert SkillTransferForm.how_disabled()=="true"
                    assert SkillTransferForm.achieve_disabled()=="true"
                    assert SkillTransferForm.get_explainBoxStatus(1)==self.CheckBox_UnCheckedStatus
                    assert SkillTransferForm.get_explainBoxStatus(2)==self.CheckBox_UnCheckedStatus
                    assert SkillTransferForm.get_showBoxStatus(1)==self.CheckBox_UnCheckedStatus
                    assert SkillTransferForm.get_showBoxStatus(2)==self.CheckBox_UnCheckedStatus
                    assert SkillTransferForm.get_practiceBoxStatus(1)==self.CheckBox_UnCheckedStatus
                    assert SkillTransferForm.get_practiceBoxStatus(2)==self.CheckBox_UnCheckedStatus
                    ...
                    focusBoxTitle=self.Longtextboxesprefix1+SkillTransferForm.get_focusBoxTitle()
                    importanceBoxTitle=self.Longtextboxesprefix1+SkillTransferForm.get_importanceBoxTitle()
                    howBoxTitle=self.Longtextboxesprefix1+SkillTransferForm.get_howBoxTitle()
                    achieveBoxTitle=self.Longtextboxesprefix1+SkillTransferForm.get_achieveBoxTitle()

                    #DateandTimeofCall=The first day of date picker
                    #BasicInfo.input_callrecordingnumber(CallRecordingNumber)
                    if lobname != "AOL":
                        BasicInfo.input_callrecordingnumber(CallRecordingNumber)
                    SkillTransferForm.input_focus(focusBoxTitle)
                    SkillTransferForm.input_importance(importanceBoxTitle)
                    SkillTransferForm.input_how(howBoxTitle)
                    SkillTransferForm.input_achieve(achieveBoxTitle)
                    SkillTransferForm.click_show(2)
                    SkillTransferForm.click_practice(1)
                    ...
                    assert SkillTransferForm.get_focus()==focusBoxTitle
                    assert SkillTransferForm.get_importance()==importanceBoxTitle
                    assert SkillTransferForm.get_how()==howBoxTitle
                    assert SkillTransferForm.get_achieve()==achieveBoxTitle
                    assert SkillTransferForm.get_explainBoxStatus(1)==self.CheckBox_UnCheckedStatus
                    assert SkillTransferForm.get_explainBoxStatus(2)==self.CheckBox_UnCheckedStatus
                    assert SkillTransferForm.get_showBoxStatus(1)==self.CheckBox_UnCheckedStatus
                    assert SkillTransferForm.get_showBoxStatus(2)==self.CheckBox_CheckedStatus
                    assert SkillTransferForm.get_practiceBoxStatus(1)==self.CheckBox_CheckedStatus
                    assert SkillTransferForm.get_practiceBoxStatus(2)==self.CheckBox_UnCheckedStatus
