...
from CoachingAndTriadCoaching_Pages.SideBySideProcessConfirmationPage import SideBySideProcessConfirmationPage
from Tablet_pages.HeaderPage import HeaderPage
from public_method.Get_AllRoleAccountForTest import Get_AllRoleAccountForTest
from selenium.webdriver.common.by import By
from Tablet_pages import BasePage

class SideBySideProcessConfirmation_PlannedToCompleted(unittest.TestCase):


    def setUp(self):
        #Case ID
        self.caseID="SideBySideProcessConfirmation_PlannedToCompleted"
        ...
        self.coachformname="Side By Side Process Confirmation" 
    ...
    def test_SideBySideProcessConfirmationForm_PlannedToCompleted(self):
        ...
        Header=HeaderPage()
        SideBySideProcessConfirmationForm=SideBySideProcessConfirmationPage()
        ...
        for i in range(0,len(self.testLOBSITE_list)):
            ...
            if Flag==True:
                ...
                for n in range(0,len(site_list)):
                    ...
                    userid=SideBySideProcessConfirmationForm.get_firstTL_HRID(1)
                    L.logout_tablet()
                    ...
                    if lobname != "AOL":
                        ...
                        for i in range(2,10):
                            assert SideBySideProcessConfirmationForm.BodyComments_disabled(i)=='true'
                        for i1 in range(3,6):
                            assert SideBySideProcessConfirmationForm.LastThreeComments_disabled(i1)=='true'
                    ...
                    for j in range(2,10):
                        SideBySideProcessConfirmationForm.input_BodyComments(j,self.Longtextboxesprefix1)
                    for j1 in range(3,6):
                        SideBySideProcessConfirmationForm.input_LastThreeComments(j1,self.Longtextboxesprefix1)
                    ...
                    for k in range(2,10):
                        assert SideBySideProcessConfirmationForm.get_BodyComments(k)==self.Longtextboxesprefix1
                    for k1 in range(3,6):
                        assert SideBySideProcessConfirmationForm.get_LastThreeComments(k1)==self.Longtextboxesprefix1
