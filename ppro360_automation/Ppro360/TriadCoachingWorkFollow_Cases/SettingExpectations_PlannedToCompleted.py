...
class SettingExpectations_PlannedToCompleted(unittest.TestCase):


    def setUp(self):
        #Case ID
        self.caseID="SettingExpectations_PlannedToCompleted"
        ...
        for i in range(0,len(self.testLOBSITE_list)):
            ...
            if Flag==True:
                ...
                for n in range(0,len(site_list)):
                    ...
                    '''Check1:Enter form detail page with title Triad Coaching - Setting Expectations'''
                    ...
                    CoachHome.click_eachcoach(1)
                    '''Check4:13.On this Setting Expectations form:
