...
class SPANISH_Performance_LC(unittest.TestCase):


    def setUp(self):
        self.caseID="SPANISH_Performance_LC"
            ...
            if Flag==True:
                ...
                for n in range(0,len(site_list)):
                    ...
                    for ywm in range(0,len(self.tablist)):
                        ...
                        print Expected_KPIofTl1["HSIAIPDSL_Actual"][0],Actual_KPIofTl1["HSIAIPDSL_Actual"][0]
                        ...
                        print Expected_KPIofAgent11["CRFT_Actual"][1],Actual_KPIofAgent11["CRFT_Actual"][1]
