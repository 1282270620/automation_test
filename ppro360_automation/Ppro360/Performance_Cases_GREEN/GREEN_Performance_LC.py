...
class GREEN_Performance_LC(unittest.TestCase):


    def setUp(self):
        self.caseID="GREEN_Performance_LC"
                ...
                for n in range(0,len(site_list)):
                    ...
                    for ywm in range(1,2):
                        ...
                        if self.tablist[ywm]=='LastMonth':
                            print 'Expected_AgentAchiev["Agent 1"][0]:', Expected_AgentAchiev["Agent 1"][0]
                            print 'Actual_AgentAchiev["Agent 1"][0]:', Actual_AgentAchiev["Agent 1"][0]
