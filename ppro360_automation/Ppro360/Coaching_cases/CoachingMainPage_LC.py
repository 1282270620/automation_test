...
class CoachingMainPage_LC(unittest.TestCase):
    '''
    classdocs
    '''
    def setUp(self):
        #Case ID
        self.caseID="CoachingMainPage_LC"
        ...
        for i in range(0,len(self.testLOBSITE_list)):
            ...
            if Flag==True:
                ...
                for n in range(0,len(site_list)):
                    ...
                    CT.Check_Header(LCname, self.role, lobname, sitename)
                    ...
                    sql_coach="select * from coach  where  assign_to_id="+self.LCuserid+" and classification=0 and status in (0,3) order by id desc"
