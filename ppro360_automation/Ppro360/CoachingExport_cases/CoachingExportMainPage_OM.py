...
class CoachingExportMainPage_OM(unittest.TestCase):
    '''
    classdocs
    '''
    def setUp(self):
        #Case ID
        self.caseID="CoachingExportMainPage_OM"
    ...
    def test_CoachingExportMainPage_OM(self):
            ...
            if Flag==True:
                ...
                for n in range(0,len(site_list)):
                    ...
                    if Type !='All':
                        ...
                        sql_coach="select * from coach  where  assign_to_id='"+self.OMuserid+"' and type='"+FormID+"' order by id desc;"
                    ...
                    SELECT MAX(active_time)\
                    FROM upload_history\
                    WHERE TYPE='2' AND DATE(data_date)<=now()) and r.team_id is not null;"
