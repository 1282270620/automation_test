...
class CoachingExportMainPage_LC(unittest.TestCase):
    '''
    classdocs
    '''
    def setUp(self):
        #Case ID
        self.caseID="CoachingExportMainPage_LC"
    ...
    def test_CoachingExportMainPage_LC(self):
            ...
            if Flag==True:
                ...
                for n in range(0,len(site_list)):
                    ...
                    if Type !='All':
                        ...
                        sql_coach="select * from coach  where  assign_to_id='"+self.LCuserid+"' and type='"+FormID+"' order by id desc;"
