...
class LC_FilterFunction_exportModule(unittest.TestCase):
    ...
    def test_LC_FilterFunction_exportModule(self):
        ...
        for i in range(0,len(self.testLOBSITE_list)):
            ...
            if Flag==True:
                ...
                for n in range(0,len(site_list)):
                    ...
                    '''Start to test........ '''
                    LCInfo=GetAccount.get_LCInfo(self.Adminurl,lobname, sitename, self.OMuserid, self.OMpassword, self.LCuserid)
                    LCpassword=LCInfo["Password"]
                    L.Login_tablet(self.tableturl,lobname,sitename,self.LCuserid,LCpassword)
                    THomepage.click_LC_coachingExportcircle()
