...
class DTVDS_Performance_Agent(unittest.TestCase):


    def setUp(self):
        self.caseID="DTVDS_Performance_Agent"
    ...
    def test_DTVDS_Performance_Agent(self):
                        ...
                        if Agent14_name!=self.Agent_name:
                            ...
                            for ywm in range(0,len(self.tablist)):
                                ...
                                if self.tablist[ywm]=="LastTwoMonth":
                                    ...
                                    Expected_KPIofTl2=GetPData_Expected.get_DTVDS_Performance_Data_Expected(106)#For Step3
                                    #Expected_KPIofAgent14=GetPData_Expected.get_DTVDS_Performance_Data_Expected(122)#For Step4
                                elif self.tablist[ywm]=="Yesterday":
                                    Expected_KPIofSITEDic=GetPData_Expected.get_DTVDS_Performance_Data_Expected(25)#For Step2
                                    Expected_KPIofTl2=GetPData_Expected.get_DTVDS_Performance_Data_Expected(24)#For Step3
                                    #Expected_KPIofAgent14=GetPData_Expected.get_DTVDS_Performance_Data_Expected(23)#For Step4
                                    ...
                                    Expected_KPIofTl2=GetPData_Expected.get_DTVDS_Performance_Data_Expected(67)#For Step3
                                    #Expected_KPIofAgent14=GetPData_Expected.get_DTVDS_Performance_Data_Expected(75)#For Step4
                                    ...
                                    Expected_KPIofTl2=GetPData_Expected.get_DTVDS_Performance_Data_Expected(87)#For Step3
                                    #Expected_KPIofAgent14=GetPData_Expected.get_DTVDS_Performance_Data_Expected(97)#For Step4
                                ...
                                if self.tablist[ywm]!="LastTwoMonth":
                                    ...
                                    Actual_KPIofTl2=GetPData_Actual.get_DTVDS_TEAM_Data_()
                                    ...
                                    Actual_KPIofAgent14=GetPData_Actual.get_DTVDS_AgentKPI_Agent_Actual()
