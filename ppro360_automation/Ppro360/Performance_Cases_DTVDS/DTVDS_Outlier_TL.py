...
class DTVDS_Outlier_TL(unittest.TestCase):


    def setUp(self):
        self.caseID="DTVDS_Outlier_TL"
    ...
    def test_DTVDS_Outlier_TL(self):
            ...
            if Flag==True:
                ...
                for n in range(0,len(site_list)):
                    ...
                    if TL1_name!=self.TL_name:
                        ...
                        for ywm in range(4,len(self.tablist)):
                            ...
                            if self.tablist[ywm]=="LastTwoMonth":
                                ...
                                Expected_Top1=GetPData_Expected.get_DTVDS_Performance_Data_Expected(115)
                                Expected_Top2=GetPData_Expected.get_DTVDS_Performance_Data_Expected(116)
                                Expected_Top3=GetPData_Expected.get_DTVDS_Performance_Data_Expected(114)
                                Expected_Bottom1=GetPData_Expected.get_DTVDS_Performance_Data_Expected(115)
                                Expected_Bottom2=GetPData_Expected.get_DTVDS_Performance_Data_Expected(116)
                                Expected_Bottom3=GetPData_Expected.get_DTVDS_Performance_Data_Expected(114)
                            if self.tablist[ywm]=="LastMonth":
                                '''TOP20:Agent11.Agent9,Agent10
                                   BOTTON20:Agent1,Agent7,Agent2'''
                                Expected_Top1=GetPData_Expected.get_DTVDS_Performance_Data_Expected(104)
                                Expected_Top2=GetPData_Expected.get_DTVDS_Performance_Data_Expected(102)
                                Expected_Top3=GetPData_Expected.get_DTVDS_Performance_Data_Expected(103)
                                Expected_Bottom1=GetPData_Expected.get_DTVDS_Performance_Data_Expected(94)
                                Expected_Bottom2=GetPData_Expected.get_DTVDS_Performance_Data_Expected(100)
                                Expected_Bottom3=GetPData_Expected.get_DTVDS_Performance_Data_Expected(95)
                            elif self.tablist[ywm]=="Yesterday":
                                '''TOP20:Agent11.Agent10,Agent4
                                   BOTTON20:Agent7,Agent2,Agent9'''
                                Expected_Top1=GetPData_Expected.get_DTVDS_Performance_Data_Expected(15)
                                Expected_Top2=GetPData_Expected.get_DTVDS_Performance_Data_Expected(14)
                                Expected_Top3=GetPData_Expected.get_DTVDS_Performance_Data_Expected(8)
                                Expected_Bottom1=GetPData_Expected.get_DTVDS_Performance_Data_Expected(11)
                                Expected_Bottom2=GetPData_Expected.get_DTVDS_Performance_Data_Expected(6)
                                Expected_Bottom3=GetPData_Expected.get_DTVDS_Performance_Data_Expected(13)
                            elif self.tablist[ywm]=="Week-to-Date":
                                '''TOP20:Agent9,Agent11,Agent10.
                                   BOTTON20:Agent7,Agent1,Agent2'''
                                Expected_Top1=GetPData_Expected.get_DTVDS_Performance_Data_Expected(63)
                                Expected_Top2=GetPData_Expected.get_DTVDS_Performance_Data_Expected(65)
                                Expected_Top3=GetPData_Expected.get_DTVDS_Performance_Data_Expected(64)
                                Expected_Bottom1=GetPData_Expected.get_DTVDS_Performance_Data_Expected(61)
                                Expected_Bottom2=GetPData_Expected.get_DTVDS_Performance_Data_Expected(55)
                                Expected_Bottom3=GetPData_Expected.get_DTVDS_Performance_Data_Expected(56)
                            elif self.tablist[ywm]=="Month-to-Date":
                                '''TOP20:Agent11,Agent9,Agent10
                                   BOTTON20:Agent1,Agent7,Agent2'''
                                Expected_Top1=GetPData_Expected.get_DTVDS_Performance_Data_Expected(85)
                                Expected_Top2=GetPData_Expected.get_DTVDS_Performance_Data_Expected(83)
                                Expected_Top3=GetPData_Expected.get_DTVDS_Performance_Data_Expected(84)
                                Expected_Bottom1=GetPData_Expected.get_DTVDS_Performance_Data_Expected(75)
                                Expected_Bottom2=GetPData_Expected.get_DTVDS_Performance_Data_Expected(81)
                                Expected_Bottom3=GetPData_Expected.get_DTVDS_Performance_Data_Expected(76)
...
if __name__ == "__main__":
    #import sys;sys.argv = ['', 'Test.test_DTVDS_Outlier_TL']
    unittest.main()