...
class ChangeToInvalidPassword_TL(unittest.TestCase):


    def setUp(self):
        #Case ID
        self.caseID="ChangeToInvalidPassword_TL"
    ...
    def test_ChangeToInvalidPassword_TL(self):
        ...
        for i in range(0,len(self.testLOBSITE_list)):
            ...
            if Flag==True:
                ...
                for n in range(0,len(site_list)):
                    ...
                    currentPassword=TLpassword
                    newPassword=TLpassword
                    reNewPassword=TLpassword
                    ChUserInfo.ChangePassword_Save(currentPassword, newPassword, reNewPassword)
