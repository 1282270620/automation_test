...
class ChangeToInvalidPassword_OM(unittest.TestCase):


    def setUp(self):
        #Case ID
        self.caseID="ChangeToInvalidPassword_OM"
    ...
    def test_ChangeToInvalidPassword_OM(self):
        ...
        for i in range(0,len(self.testLOBSITE_list)):
            ...
            if Flag==True:
                ...
                for n in range(0,len(site_list)):
                    ...
                    currentPassword=self.OMpassword
                    newPassword='      '
                    reNewPassword='      '
                    ...
                    #Step2.8:Verify all are self.OMpassword
                    currentPassword=self.OMpassword
                    newPassword=self.OMpassword
                    reNewPassword=self.OMpassword
                    ChUserInfo.ChangePassword_Save(currentPassword, newPassword, reNewPassword)
