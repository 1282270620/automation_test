...
class CheckHomePageModules_SVP(unittest.TestCase):


    def setUp(self):
        #Case ID
        self.caseID="CheckHomePageModules_SVP"
        ...
        self.SVPuserid="11223344"
        self.SVPpassword="111111"
        #Get LC userid
    ...
    def test_CheckHomePageModules_SVP(self):
        ...
        for i in range(0,len(self.testLOBSITE_list)):
            ...
            if Flag==True:
                ...
                L.Login_tablet(tableturl, lobname, sitename, self.SVPuserid, self.SVPpassword)
