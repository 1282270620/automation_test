...
from Performance_Cases_CENTURYLINK.Get_PerformanceData_Expected_CENTURYLINK import Get_PerformanceData_Expected_CENTURYLINK
from Performance_Cases_CENTURYLINK.Check_All_CENTURYLINK import Check_All_CENTURYLINK
...
class CENTURYLINK_Performance_OM(unittest.TestCase):


    def setUp(self):
        self.caseID="CENTURYLINK_Performance_OM"
        ...
        #Yesterday,WTD,MTD for CENTURYLINK
    ...
    def test_CENTURYLINK_Performance_OM(self):
        ...
        #Get Goal Expected
        GetPData_Expected=Get_PerformanceData_Expected_CENTURYLINK()
        Check_all=Check_All_CENTURYLINK()
        lineindex=2#The goal is in the row 3 of excel file,so linedex is 2
        Expected_GoalDic=GetPData_Expected.get_CENTURYLINK_Goal_Expected(lineindex)
        ...
        for i in range(0,len(self.testLOBSITE_list)):
            ...
            if Flag==True:
                ...
                for n in range(0,len(site_list)):
                    ...
                    Achiev_SITE_Monthly=GetPData_Actual.get_CENTURYLINK_SITE_Data_()['Achiev'][0]
                    ...
                    if lobname in Gl.performancefor_MultiTimeTab_lob:
                        for i in range(0,len(Timetablist)):
                            ...
                            Actual_GoalDic=GetPData_Actual.get_CENTURYLINK_Goal_Actual()#GET ACTUAL GOAL FORM PERFORMANCE PAGE
                            ...
                            Actual_KPIofSITEDic=GetPData_Actual.get_CENTURYLINK_SITE_Data_()
                            #Step2:Verify SITE
