...
from Performance_Cases_PAYPAL.Get_PerformanceData_Expected_PAYPAL import Get_PerformanceData_Expected_PAYPAL
from Performance_Cases_PAYPAL.Check_All_PAYPAL import Check_All_PAYPAL
...
class PAYPAL_Performance_OM(unittest.TestCase):


    def setUp(self):
        self.caseID="PAYPAL_Performance_OM"
    ...
    def test_PAYPAL_Performance_OM(self):
        ...
        #Get Goal Expected
        GetPData_Expected=Get_PerformanceData_Expected_PAYPAL()
        Check_all=Check_All_PAYPAL()
        lineindex=3#The goal is in the row 3 of excel file,so linedex is 2
        Expected_GoalDic=GetPData_Expected.get_PAYPAL_Goal_Expected(lineindex)
        ...
        for i in range(0,len(self.testLOBSITE_list)):
            ...
            if Flag==True:
                ...
                for n in range(0,len(site_list)):
                    ...
                    Achiev_SITE_Monthly=GetPData_Actual.get_PAYPAL_SITE_Data_()['Achiev'][0]
                    ...
                    if lobname in Gl.performancefor_MultiTimeTab_lob:
                        for i in range(0,len(Timetablist)):
                            ...
                            Actual_GoalDic=GetPData_Actual.get_PAYPAL_Goal_Actual()#GET ACTUAL GOAL FORM PERFORMANCE PAGE
                            ...
                            Actual_KPIofSITEDic=GetPData_Actual.get_PAYPAL_SITE_Data_()
                            #Step2:Verify SITE
